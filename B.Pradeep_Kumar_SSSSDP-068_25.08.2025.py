...
2) Both  input  and  output  are  lists
'''
a=set(eval(input("Enter a 1st list : ")))
b=set(eval(input("Enter a 2nd list : ")))
c=a.intersection(b)
print(f"Output list is :",list(c))
...
a = {10 : 20 , 30 : 40}
b = {30 : 50 , 10 : 60}
#print(a + b)  # Error due to + operator in dict
c = {**a , **b} 
print(c)  #  {30 : 50 , 10 : 60}
d = a | b  
print(d)  #  {30 : 50 , 10 : 60}
...
print(sum(a))  #  90
print(sum(a . items()))  #   Error due to items cant be added
