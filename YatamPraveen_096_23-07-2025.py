...
print(floor(3.5))                              #Returns error
print(ceil(3.5))                                #Returns error
...
print(math . gcd(0 , 7))                     #0
print(math . gcd(3 , 0))                     #0
print(math . gcd(0 , 0))                     #0
print(gcd(5 , 15))                              #Returns error
...
import  builtins
print(builtins . max(10 , 20 , 30))                 #10   
...
How  to  print  kwlist                               #from keyword import kwlist
                                                                   print(kwlist)
How  to  print  number  of  keywords     #from keyword import kwlist
                                                                   print(len(kwlist))
How  to  print  type  of kwlist                  #from keyword import kwlist
                                                                   print(type(kwlist))
print(keyword . kwlist)                              #Prints the lists that contains all the keywords
...
How  to  print  kwlist                           #print(keyword.kwlist)  or print(kwlist) if we import kwlist from keyword
How  to  print  number  of  keywords      #print(len(keyword.kwlist)) or print(len(kwlist))
How  to  print  type  of kwlist                   #print(type(keyword.kwlist)) or print(type(kwlist))
print(kwlist)                                                #Prints kwlist if we import kwlist from keyword else error