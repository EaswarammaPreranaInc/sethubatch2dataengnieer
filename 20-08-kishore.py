...
# List comprehension
result = [[word.upper(), len(word)] for word in words]
...
result = []
length = min(len(list1), len(list2))   # take only till the smaller list length
...
# List comprehension with range of smaller list
...
result = []
for i in range(rows):
    result.append([0] * cols)   # repetition operator * used here
...
[20-08-2025 12:42] +91 99482 50500: Enter  list  of  strings :  ['Swathi' , 'Anand' , 'Srinivas' , 'Zebra' , 'King' , 'Amar' ]
