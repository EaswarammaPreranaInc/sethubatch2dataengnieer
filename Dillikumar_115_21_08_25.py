...
print(a)
print(type(a))   # 25 , 10.8 , 3 + 4j , 'Hyd' , True , None , 'Hyd' , 25
...
a = (1,2,3)
b = (4,5,6)
print(a , id(a)) # (1,2,3) 140467357271168

a += b
print(a , id(a)) #(1,2,3,4,5,6), 140356789012345

#  Find  outputs
c
a = a + b
print(a , id(a)) # (1,2,3,4,5,6)  ,  140587204053008
...
d = True
x = a , b , c , d
print(x)  # (25, 10.8, 'Hyd' , True) # empty vales to tuple 
