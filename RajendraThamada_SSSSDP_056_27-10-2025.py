...
print(7 / 0)	# Error this statement should be inside try block
try:
	print(7 / 0)
...
try:
        ...
        print('Two')
        print('Three')
print('Four') # Error try and except block should be one after another
except:
		print('Five')
		print('Six')
		print('Seven')
...
except:						# Error there should be only one default except
...
print(eval("   'Ten'   "))	# Ten
print(eval('Ten'))	# NameError Ten is not defined
...
s = {10 , 20 , 15 , 18}
print(s[4])	#TypeError  set is not indexed
d = {10 : 'Hyd' , 20 : 'Sec'}
...
s = {10 , 20 , 15 , 18}
print(s[0])	# TypeError
b = { [10 , 20] : [30 , 40] }	# TypeError key should be immutable
...
try:
	print('Begin')	# Begin
	f1(10)		# f1 function <nextline> Caught  TypeError  outside  the  function :   25
	f1(20)
	f1(30)
	f1(0)
except  ArithmeticError:
...
f1(10)	# Caught ValueError : 25  <nextline> End of f1 function
f1(20)	# Caught NameError : 10.8	<nextline> End of f1 function
f1(30)	# Caught IndexError : Hyd <nextline> End of f1 function
f1(0)	# Caught EOFError : True <nextline> End of f1 function
...
for  i  in  range(10):
        print('Main  Thread')
child . start()		# RuntimeError: threads can only be started once
...
# End of the class
t = Thread()
#t . start()	# AttributeError: 'Thread' object has no attribute 'start'
for  i  in  range(10):
    print('main  thread')	# main thread repeat 9 times
