...
1) prime(25) → loop executed 4 times
2) prime(11) → loop executed 2 times
3) prime(2)  → loop executed 0 times
4) prime(49) → loop executed 6 times
