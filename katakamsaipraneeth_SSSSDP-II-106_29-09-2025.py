...
print('e  :  ' , e) # 2 / 3
print('f  :  ' , f) # 11 / 15
c . _init_() # object  'c'   --->  nr = 22 , dr = 7
print('c  :  ' , c) # 22 / 7
a . _init_(3.8  , 4.6) 
print('a  :  ' , a) # 3.8 / 4.6
g = Rat(nr1 = 9 , 5) # error
h = Rat(nr = 9 , dr = 5) # error arg names not permited
...
del  a . x # x is removed
del  b . y # y is removed
...
#end of the  class
a = f1() # obj f1
print(a) # constructor  type and address
...
#  Find  outputs (Home  work)
from  prog9a  import  c1 # imported and discared
class   c1:
	def  _init_(self):
...
class   c1:
	...
	def  _del_(self):
		print('destructor')
		b = c1()
a = c1() # constructor destructor constructor destructor ..................
...
del   a # Object  at  address  1000  is  lost
print('Hello') # Hello
del   b # Object  at  address  2000  is  lost
print('Hi') # Hi
del   c # Object  at  address  3000  is  lost
print('Bye') # Bye
d = c1() # Object  is  created  at  address  : 1000
print('End') # Object  at  address  1000  is  lost
	     # End
...
del  list
'''
Object  is  created  at  address  :   1906972517520
Object  is  created  at  address  :   1906972517648
Object  is  created  at  address  :   1906972517712
Object  at  address  1906972517712  is  lost
Object  at  address  1906972517648  is  lost
Object  at  address  1906972517520  is  lost
'''
