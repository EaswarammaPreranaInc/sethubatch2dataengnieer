...
o.inner.m1(o)# How  to  call  m1()  method  of  inner  class
i = outer.inner()
...
o.inner1.disp(o) # How  to  call   disp()  method  of inner1  class
o.inner2.disp(o) # How  to  call   disp()  method  of inner2  class
...
i1.c2() # How  to  create  inner  c2  class  object
i2 = c2() # How  to  create  outer  c2  class  object
...
i = c2()
i.c2()  # How  to  create  inner  c2  class  object  in  another  way
