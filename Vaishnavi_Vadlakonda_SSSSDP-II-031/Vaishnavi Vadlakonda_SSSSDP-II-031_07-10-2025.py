...
class  deque:
	...
	def isempty(dq):
		if dq.list == []:
			...
			return False # return  True  when  deque  is  empty  and  False  otherwise
	def ins_rear(dq , x):
	...
	def del_front(dq):
		if dq.list != []:
			return dq.list.pop(0) # How  to  remove  left  most  element  of  the  deque  and  return  the  deleted  element
		else:
			return None # (return  None  when  deletion  is  not  possible)
	def del_rear(dq):
		if dq.list != []: # How  to  remove  right  most  element  of  the  deque  and  return  the  deleted  element
			return dq.list.pop()
		else:
			return None # (return  None  when  deletion  is  not  possible)
	def left(dq):
...
while True:
	...
	match ch:
		case 1:
			...
			print(dq.disp()) # How  to  print  deque
		case 2:
			x = eval(input('Enter  element  to  be  inserted : '))
			dq.ins_front(x) # How  to  insert  'x'  at  the  begining  of  deque
			print(dq.disp()) # How  to  print  deque
		case 3:
			print(dq.del_front()) # How  to  delete  left  most  element  of  deque  and  print  the  deleted  element
			print(dq.disp()) # How  to  print  queue
		case 4:
			print(dq.del_rear()) # How  to  delete  right  most  element  of  deque  and  print  the  deleted  element
			print(dq.disp()) # How  to  print  queue
		case 5:
			print(dq.disp()) # How  to  print  the  queue
		case 6:
			print(dq.left()) # How  to  print  left  most  element  of  deque
		case 7:
			print(dq.right()) # How  to  print  right  most  element  of  deque
		case 8:
