...
class Rat:
	...
	def _add_(self, a , b):  #  Modify  the  method
		self . nr = a . nr * b . dr + a . dr * b . nr
		self . dr = a . dr * b . dr
		self . simplify()
	def _sub_(self, a , b):   #  Modify  the  method
		self . nr = a . nr * b . dr - a . dr * b . nr
		self . dr = a . dr * b . dr
		self . simplify()
	def _mul_(self ,  a , b):   #  Modify  the  method
		self . nr = a . nr * b . nr
		self . dr = a . dr * b . dr
		self . simplify()
	def _truediv_(self, a , b):   #  Modify  the  method
		self . nr = a . nr * b . dr
		self . dr = a . dr * b . nr
		self . simplify()
...
class Complex:
    def _init_(self, real=0.0, imag=0.0):
...
'''
Outputs
c1  class  gt  method : 10 20
c1  class  gt  method : 20 10
c2  class  gt  method : 30 10 
c2  class  gt  method : 20 40
'''
...
a = c1()
b = c1()
print('a + b : ' , a + b) # a + b : add method  of  class   c1
print('a + 7 : ' , a + 7) # a + 7 : add method  of  class   c1
print(7 + a) # Error because can't add int and c1
print('7 + 8 : ' , 7 + 8) # 7 + 8 : 15
m = c2()
n = c2()
print(m + n) # Error cannot add c2 and c2  because there is no _add_ method in c2 class
print('a + m : ' , a + m) # a + m : add method  of  class   c1
print(m + a) # Error cannot add c2 and c1  because there is no _add_ method in c2 class
