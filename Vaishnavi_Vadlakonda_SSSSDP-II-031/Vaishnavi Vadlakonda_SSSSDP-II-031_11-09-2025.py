...
def f2 (fun):
	print('f2  function')
	fun() # Error because None is an object not a function
	print('Back  to  f2  function')
# end of the function
print('Begin')
f2(f1())
...
fun()
print('Bye')
inner() # Error because inner function cannot be visible to outside function
'''
Outputs
Outer Function
Hello
...
print(div(10 , 3))
print(div(10 , 0))
print(inner(10, 3)) # Error because inner is not visible to outside of function and other functions
'''
Outputs
3.33
