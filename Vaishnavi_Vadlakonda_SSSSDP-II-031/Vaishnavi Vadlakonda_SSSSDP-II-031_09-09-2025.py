...
print('End')
'''
prints 3 infinitely because every time function is called a is initialized to 3
'''
...
print = None
print('Hello') # Error because print = None and None is not a function so it cannot be called
