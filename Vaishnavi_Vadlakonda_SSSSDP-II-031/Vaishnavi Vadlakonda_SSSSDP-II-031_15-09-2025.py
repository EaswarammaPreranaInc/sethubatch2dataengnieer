...
def f1():
    ...
    yield  100
# End of generator
g = f1() # new empty generator object is created
for x in g:
	print(x)
	print(type(x))
'''
...
def f1():
    ...
    yield  40
a , b , c = f1() 
p , q , r , s , m = f1() # Error because too many values to unpack
...
# End  of  generator
g =  f1()
print(len(g)) # Error no len function for gennerator
print(g * 3) # Error generator object cannot be repeated
print(g[0]) # Error generator object has no index
print(g[1 : 3]) # Error generator object has no index, so no slicing
print(*g) # 1 2 3