...
try:
	print('try')
else: # Error, else suite should be there after except suite
    print('else')
finally:
    print('finally')
print('End')
...
try:
	...
	print('else1')
else: # Error, there must be only one else
	print('else2')
finally:
	print('finally')
print('end')
...
try:
	print('try')
else: # Error, else suite must be after except
	print('else')
except:
	print('except')
finally:
...
Inner  try  finally
Outer  try  finally
Error, because TypeError raised by inner try is not handled
'''
...
1
6
Error, because error reraised in except suite is noy caught
'''
...
'''
Outputs
Rama  guess  6   in  attempt  :  1
Sita  guess  8   in  attempt  :  2
outputs printed until x of t1 reaches 75 and x of t2 reaches 50
outputs changes run to run
'''
