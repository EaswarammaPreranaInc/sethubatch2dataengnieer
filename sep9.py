...
repeats continously due to no end for the above recursion
'''
...
f1()                 # f1    function
f2()                 # f2  function
print(f1 is f2)      # False, because they are two different functions
f2 = f1
f2()                 # f1 function now f2 refers to f1
print(f1 is f2)      # True, because f2 now refers to the same function as f1
