...
'''
from p1.mod1 import x as num1,f1 as fun1,c1 as cls1 #How  to  import   members  of  mod1   in  package  p1  with  from  statement
from p1.mod1 import x as num2,f1 as fun2,c1 as cls2 #How  to  import   members  of  mod2   in  package  p1  with  from  statement
print(num1) #How  to  print  object  'x'  of   mod1  in  package  p1
fun1() #How  to  call  function  f1()  of   mod1  in  package  p1
a=cls1()
a.m1()#How  to  call  method  m1()  of   class  c1  in  mod1  of  package  p1
print()
print()
print(num2)#How  to  print  object  'x'  of   mod2  in  package  p1
