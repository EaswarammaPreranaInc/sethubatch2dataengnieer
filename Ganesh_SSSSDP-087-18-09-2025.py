...
# Store  sample.py  module  in  C:\Users\aprav\SSSDP GIT  folder  before  the  program  is  executed  (Home  work)
import sys,sample
print(len(sys.path)) 				# How  to  print  number  of  directories  (or)  folders  in  sys.path
sys.path.append(r'C:\Users\aprav\SSSDP GIT') 	# How  to  append  c:\sairam  folder  to  sys.path
print(len(sys.path) 				# How  to  print  number  of  directories  (or)  folders  in  sys.path
