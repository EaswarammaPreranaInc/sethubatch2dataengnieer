...
set_lst, cnt_lst=list(set(lst)), []
for i in set_lst:
    cnt_lst.append(lst.count(i))
temp = cnt_lst.index(max(cnt_lst))
print('Mode : ', set_lst[temp])
...
for  x , y  in  a:
	print(x , y ,	sep = '...')    #10...20<Then it returns error as at this point code equals to x, y in [30, 40, 50] since the list has more elements than the variables to which the elements are assigned, error is raised>
