...
print(avg(25 , 10.8 , True))#12.6666
print(avg(10.8 , 20.6 , 15.2 , 14.9 , 9.8))#14.26
#print(avg())#0Zero division error
print(avg(25))#25.0
...
def   f1(a = 25  , *b):
        print(F'a : {a}  \t   b  :  {b} ')
f1(10 , 20 , 30 , 40)#a:25  b:(20,30,40)
f1(50 , 60)#a:50    B:60
f1(70)#a: 70    b:()
f1(a = 80)#a: 80    b:()
...
f1(a = 1 , 2 , c = 3)#Error
f1(1 , 2 , 3)#c keyword argument is missing
