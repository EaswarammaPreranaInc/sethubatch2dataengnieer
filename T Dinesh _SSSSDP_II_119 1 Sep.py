...
def   f1(a = 'Hyd' , b = []):
	...
	print('b :  ' , b)
# End of the function
print('Default Values  :  ' , f1.__defaults_)   # ('Hyd', [])
f1()                                           # a :   HydSec
                                               # b :   [1, 2, 3]
print('Default Values  :  ' , f1.__defaults_)   # ('Hyd', [1, 2, 3])
f1()                                           # a :   HydSec
                                               # b :   [1, 2, 3, 1, 2, 3]
print('Default Values  :  ' , f1.__defaults_)   # ('Hyd', [1, 2, 3, 1, 2, 3])
f1()                                           # a :   HydSec
                                               # b :   [1, 2, 3, 1, 2, 3, 1, 2, 3]
