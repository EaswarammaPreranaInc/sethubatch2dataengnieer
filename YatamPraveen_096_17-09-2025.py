...
print('Bye') 			# Bye
import  mod4
print(x)    			# Error as x is not available in current module
f1()
...
mod2 . f1()
print('After')  			# After
run_module('mod2')  			# Error as run_module has not be imported to be used
runpy . run_module(mod2) 		# Error as argument of run_module should be string module
...
print(cal . x) 			# Error since we are using cal module without importing
print(add(10,7)) 		# 17
print(sub(10 , 7)) 		# Error as function sub is not available in current module
print(mul(10,7)) 		# 70
print(div(10 , 7)) 		# Error as function div is not available in current module
a=c1() 
a.m1()  			# m1 method
...
from  math  as   m  import  *  		# Error as module is not imported in this case. Only members of the module are imported 
...
print(object) 			# 100
print(x) 			# Error as x is being imported by another name
print(fun1) 			# 17
print(fun2) 			# 70
a=class()
a.m1() 				# m1 method
print(add(10 , 7)) 		# Error as add function is imported as fun1
b = c1() 			#Error as class c1 is imported as class 
...
print(add(10 , 7))  	# Error as add function is not available in current module
print(sub(10 , 7))  	# 3
print(mul(10 , 7))  	# 70
print(div(10 , 7))  	# Error as div function is not available in current module
a = c1()    		# class c1 is not available in current module
...
# Find  outputs  (Home  work)
import  mod1
import  mod1    	# Does nothing since mod1 is already imported
...
print() # nothing
importlib . reload(mod1)    	# Hyd<nextline>Sec<nextline>Cyb
importlib . reload('mod1')  	# Error as the argument of reload function should be module not string module
reload(mod1)    		# Error as reload function is not available in current module
'''