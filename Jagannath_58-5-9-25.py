...
print( lambda   x  :  x * x(7))                   <function <lambda> at 0x7f7c74156340>
print( lambda   x  :   x * x)                     <function <lambda> at 0x7f7c74156340>
...
print(add())                                                                       Error
print(add)                                                                         <function <lambda> at 0x7b1a8394d260>
...
print(lambda  x , y : x + y  ('Hyder'  ,  'abad'))                 <function <lambda> at 0x738f35ca6340>
...
a  =  lambda  :  'Hyd'
print(a())                            Hyd
print(a)                              <function <lambda> at 0x70847e7ca340
...
print(a)                                                               (<function <lambda> at 0x75ebc2d82340>,None,None) 
for  x  in  a:
	print(x)                                                             <function <lambda> at 0x75ebc2d82340> 
                                                                       None
                                                                       None
a()                                                                    Error
print(a[0]())                                                          Hyd
...
#  Find  outputs  (Home  work)
s = 'Hyd'
print(lambda  s  :  print(s))                             <function <lambda> at 0x744324596340>
print(lambda  x  :  print(x) (s))                         <function <lambda> at 0x744324596340>
...
print(a)                                                            Hyd
                                                                    Sec
                                                                    [<function f1 at 0x7be755682340>,<function f2 at ox7be7554893a0>]
...
key = 'power_3'
print(a[key])                                          <function <lambda> at 0x7a430a4353a0>
print(a[key](5))                                       125
...
print(lamb(2))                         9
print(lamb(5))                         243
print(lamb)                            <function f1.<locals>.<lambda> at 0x7ef9040c13a0>
print(lamb())                          Error
...
while n > 1:
    ...
    user = int(input("Pick 1, 2, 3 or 4 matchsticks: "))
    ...
    n -= user
    print(f"You picked {user}, Remaining = {n}")
    
    if n == 1:  
        print("Only 1 matchstick left. You are forced to pick it.")
    ...
    comp = 5 - user
    n -= comp
    print(f"Computer picks {comp}, Remaining = {n}")
    
    if n == 1:
        print("Only 1 matchstick left. You must pick it.")
        print("You lose! Computer wins")
        break
...
print(f"Arabic number = {arabic_num}")
