...
p , q , r , s , m = f1()
	...
	# output
	 # error more values and less variables
 	 # error more varibles and less values
...
# End  of  generator
g =  f1()
print(len(g))					# error not length method
print(g * 3)					# error generator multiply integer
print(g[0])					# error generator not indexed
print(g[1 : 3])					# error
print(*g)					# 1  2  3
