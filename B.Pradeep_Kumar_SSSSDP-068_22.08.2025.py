...
a  =  10 ,  20 ,  30 ,   40 ,  50
#     0      1       2       3      4
#a[2] = 35  #  Error due to tuple is not modified
...
a  = 10 , 20 , 30 , 40 , 50
   0     1      2     3      4
a . remove(30)  #  Error due to remove method is not in tuple
del  a[2]  #  Error due to del method is not in tuple
a . pop(2)  #  Error due to pop method is not in tuple
print(a)  #   (10 , 20 , 30 , 40 , 50)
print(id(a))  #  address of object a
a=a[:2] + a[3:]  #How  to  remove  30  from  tuple  'a'
print(a)  #  (10 , 20 , 40 , 50)
print(id(a))  #  Address of new tuple object a
...
print(*a)   #  How     print  inner  tuple  in  another  way)
...
b = eval(a)  #  str set converted to set
...
a = range(100 , 151 , 10)
b = set(a)  #  {100,110,120,130,140}
print(b)  #  {100,110,120,130,140}
c = [10 , 20 , 15 , 18 , 10 , 50 , 20 , 12 , 18]
d = set(c) 
print(d)  #  {10 ,  15  , 50 , 20 , 12 , 18}
e = set('Rama  rAo') 
print(e)  #  # {'m', 'o', 'A', ' ', 'r', 'a', 'R'}
print(set(25))  #  error due to arguments must be sequence
print(set())  #  emty set
