...
3) Which  object  has  prefix  expression ? ---> A  str  object
...
6) What  does  stack  finally  contain ?  ---> Result  of  the  prefix  expression

7) prefix  expression  is  bracket  free  expression
