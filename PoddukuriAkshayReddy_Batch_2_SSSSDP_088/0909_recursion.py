...
for m in range(1,n+1):
  print('Fibonacci term', m ,':',fib(m),end =' ')
...
print(f'Power of {a} raised to {b} is : {power(a,b)}')
...
print(f'Reverse Number of {n} is : {rev(n)}')
...
#End  of  the  function
a = 3
f1() # infinite loop due to local variable a
print('End')
...
f1()
'''
infinite loop due to mutual recursion
'''
...
p = len
print(p('Hyderabad')) # How  to  call  len()  function  thru  ref  'p'  and   print  length  of  'Hyderabad'
