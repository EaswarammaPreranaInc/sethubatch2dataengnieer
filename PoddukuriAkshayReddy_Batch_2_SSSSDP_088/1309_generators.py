...
# generators : functions that return an object (iterator) which we can iterate over (one value at a time)

# given input 1 and input 2 , with these we have print sum,sub,mul,div
