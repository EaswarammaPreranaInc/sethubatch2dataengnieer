[22-10-2025 12:53] SRINIVAS Sir SSSSDP: # Find  outputs (Home  work)
from  abc  import  *
class  c1(ABC):
	@abstractmethod
	def  m1(self):
...
class  shape(ABC):
	def   get(self):
		self.a = float(input("Enter the value of a : ")) # How  to  read  value  of  'a'
	@abstractmethod
	def   area(self):
		pass
	@abstractmethod
...
class   rectangle(shape):
	def  get(self):
		...
		super().get() # How  to  read  length  and  breadt
