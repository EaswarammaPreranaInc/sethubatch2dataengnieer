...
# super(classname,object)  # because of static method we can give classname and child  line 80
...
class   parent:
	...
	def  m1(self):
		...
		# print(x) # error no local or global variable x
# End  of  parent  class
class   child(parent):
	y = 20
	def  m2(self):
		...
		print(super() . y) # error 
		# print(y) # error no local or global variable y
# End  of child  class
p = parent()
parent.m1() # How  to  call   m1()  method  of  parent  class
c = child()
...
class child(parent):
	def get(self):
		...
		self.d = int(input('Enter any number'))
...
while  True:
	...
	# End  of  match
[13-10-2025 11:37] SRINIVAS Sir SSSSDP: '''
...
while  True:
	...
	match   ch:
		...
		case  4:
			How  to  stop  execution
[13-10-2025 11:37] SRINIVAS Sir SSSSDP: # Find  outputs
class  c1:
	def  m1(self):
...
[13-10-2025 11:41] SRINIVAS Sir SSSSDP: # Find  outputs
class  c1:
        pass
class  c2(c1):
        pass
...
print(issubclass(c4 , [int , float , c1 , str , bool]))
[13-10-2025 11:45] SRINIVAS Sir SSSSDP: #  Find  outputs
class  c1:
        pass
class  c2(c1):
        pass
