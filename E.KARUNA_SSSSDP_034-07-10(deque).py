...
class  deque:
	...
	def  size(dq):
		return ('number of elements:' ,len(dq.list))#return  number  of  elements  in  the  deque
#End of the class
def  menu():
...
while  True:
	...
	match  ch:
		...
		case  2:
					x = eval(input('Enter  element  to  be  inserted : '))
					dq.ins_front#How  to  insert  'x'  at  the  begining  of  deque
					dq.disp()#How  to  print  deque
		case  3:
					dq.del_front#How  to  delete  left  most  element  of  deque  and  print  the  deleted  element
					dq.disp()#How  to  print  queue
		case  4:
					dq.del_rear#How  to  delete  right  most  element  of  deque  and  print  the  deleted  element
					dq.disp()#How  to  print  queue
		case  5:
					dq.disp()#How  to  print  the  queue
		case  6:
					print(dq.list[0])#How  to  print  left  most  element  of  deque
		case  7:
					print(dq.list[-1])#How  to  print  right  most  element  of  deque
		case  8:
					dq.size()#How  to  print  number  of  elements  in  deque
		case  9:
