...
def primes_in_range(start,end):
    print(F'Prime Numbers between {start,end} are')
    ctr=0
    for n in range(start,end+1):
        if prime(n):
            print(n)
            ctr +=1
    print(F'Number of Prime Numbers between {start,end} are :',ctr)    
start=int(input("Enter Prime Numbers From :"))
end=int(input("Enter Prinme Numbers Upto :"))
...
disp(80 , 90) # 3-argument  function  : 80 90 30
