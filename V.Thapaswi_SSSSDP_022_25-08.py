#1)  intersection()   method  demo  program
a = {10 , 20 , 30 , 40}
b = {30 , 40 , 50 , 60}
c = a . intersection(b)
print(c)#{40,30}
...
# 2) difference()   method  demo  program  
a = {10 , 20 , 30 , 40}
b = {30 , 40 , 50 , 60}
c = a . difference(b)
print(c)#{10,20}
...
# 3) symmetric_difference()   method  demo  program
a = {10 , 20 , 30 , 40}
b = {30 , 40 , 50 , 60}
...
print("Original list:", numbers)#[10, 20, 10, 30, 40, 20, 50, 30]
print("Without duplicates:", unique_list)#[40, 10, 50, 20, 30]
...
print("List 1:", list1)#[10, 20, 30, 40, 50]
print("List 2:", list2)#30, 40, 50, 60, 70]
print("Common elements (set):", common)#{40, 50, 30}
print("Common elements (list):", common_list) #[40, 50, 30]
...
print(a['Empno'])# 25 , How  to  print  value  25  in  dict  'a'
print(a['Ename'])# Rama Rao , How  to  print  'Rama Rao'  in  dict  'a'
print(a['Sal']) #1000.65 , How  to  print  value  1000.65   in  dict  'a'
