...
# a . pop(2) error, tuple is immutable
print(a) # (10 , 20 , 30 , 40 , 50)
print(id(a)) #address of the tuple object, say 1000
...
# print({[10 , 20 , 30]}) set does not allow mutable elements
# print({{10 , 20 , 30}}) set does not allow mutable elements
# print({{}})set does not allow mutable elements
...
e = set('Rama  rAo')
print(e) #{'R','a','m',' ','r','A','o'}
# print(set(25))#error, argument should be only sequence
print(set()) #{}
