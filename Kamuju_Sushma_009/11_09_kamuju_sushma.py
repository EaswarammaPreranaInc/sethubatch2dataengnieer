...
# end of the function
print('Begin') #begin
f2(f1()) #error fun refers to None , calling None object gives error
print('End') #end
...
def  f1():
        return  10
#end  of  the  function
f1 = decor(f1) #this is alternate to  @decor 
print(f1()) #12
...
def  div(a , b):
        return  a / b
# End  of  the  function
print(div(10 , 3)) #infinite recursion
