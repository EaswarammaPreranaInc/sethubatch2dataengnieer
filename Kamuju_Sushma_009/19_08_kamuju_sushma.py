...
# [60 , 70 , 80 , 90]
for  x , y  in  a:
	print(x , y ,	sep = '...') #error, we provided 2 reference but list has more values
...
print(sorted(a))#[[5 , 'Amar'  ,5000.0],[10 , 'Rama' , 1000.0], [15 , 'Rajesh' , 3500.0],
#   [18 , 'Kiran' , 2800.0], [20 , 'Sita' , 2000.0] ]
print(sorted(a , reverse = True)) #[[20 , 'Sita' , 2000.0],  [18 , 'Kiran' , 2800.0], [15 , 'Rajesh' , 3500.0]
