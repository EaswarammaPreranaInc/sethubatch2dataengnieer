...
import cal
print(dir(cal))
# ['__builtins__', '__cached__', '__doc__', '__file__', '__loader__', '__name__', '__package__', '__spec__', 'add', 'mul', 'x']
...
# 1) '__name'.startswith('__')  ---> True
# 2) '__spec'.endswith('__')    ---> False
# 3) 'spec__'.startswith('__')  ---> False
...
# Before import shows current names like ['__annotations__', '__builtins__', ...]
...
print(type(dir))
'''
['In', 'Out', '_', '__', '___', '__builtin__', '__builtins__', '__doc__', '__loader__', '__name__', '__package__', '__session__', '__spec__', '_dh', '_i', '_i1', '_i2', '_i3', '_ih', '_ii', '_iii', '_oh', 'c1', 'disp', 'exit', 'get_ipython', 'math', 'open', 'quit', 'sys', 'time', 'x']
<class 'list'>
