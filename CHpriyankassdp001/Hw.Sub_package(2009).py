...
from  p1 . mod1    import    *
from  p1 . mod2    import    *     # How  to  import  mod1   and  mod2  of  package  p1  with  from  statement
...
a=c1()
a.m1()                 # How  to  call  method  m1()  of   class  c1  in  mod2  of  package  p1
print(p1 . mod1 . x)   # Error, module not imported
print(mod1 . x)        # Error, module not imported
from  p1   import  mod1 . *      # Error, due to dot not allowed in import clause of from statement
...
'''
from p1.mod1 import x as s1, f1 as f, c1 as c  # How  to  import   members  of  mod1   in  package  p1  with  from  statement
from p1.p2.mod2 import x as s2, f1 as f2, c1 as c2   # How  to  import   members  of  mod2   in  package  p1  with  from  statement
print(s1)                   # How  to  print  object  'x'  of   mod1  in  package  p1
f()                     # How  to  call  function  f1()  of   mod1  in  package  p1
a=c        
a.m1()            # How  to  call  method  m1()  of   class  c1  in  mod1  of  package  p1
print()
print()
print(s2)            # How  to  print  object  'x'  of   mod2  in  package  p1
...
# Save  in  any  file  of  cwd
from p1.mod1 import *    # How  to  import  mod1  of  package  p1  with  from  statement
print(x)                 # How  to  print  object  'x'  of   mod1  in  package  p1
f1()                    # How  to  call  function  f1()  of   mod1  in  package  p1
a=c1()
a.m1()                   # How  to  call  method  m1()  of   class  c1  in  mod1  of  package  p1
print(p1 . mod1 . x)       # Error due to module not imported
print()
print()
from p1.p2.mod2 import *  # How  to  import  mod2  of  sub-package  p2  in  package  p1  with  from  statement
...
print(p1 . p2 . mod2 . x)   # Error due modules are not imported
from  p1  import   p2 . mod2     # Error due dot not allowed in import clause of from statement
