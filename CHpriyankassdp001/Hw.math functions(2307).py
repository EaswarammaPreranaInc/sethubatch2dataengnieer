...
a = 25       # reference a points to the int object i.e. 25
print(++a)  #  +(+a) = +a  =  25               
#print(a++)   #  (a+)+  =  a+ =  25+  throws   error
print(a++1)  #  a + (+1)  =  a +  1 = 25 + 1  = 26
print(--a)       # -(-a)= +a= 25
#print(a--)      # (a-)-  =  a+ =   25+  ---> throws the Error 
print(a--1)    # a-(-1)  =  a+1 = 25+1 =26
print(-a)       # -25
print(+-a)     # +(-a)  =  -a = -25
print(-+a)      # - (+a) = -a = -25
...
#print(floor(3.5))  	 # it throws Error due to floor is not imported
#print(ceil(3.5))  # it throws Error due to ceil is not imported		
...
#print(gcd(5,15))		#Error due to gcd is not import in this program     we can call through the math.gcd
...
print(abs(29.5))	#29.5
print(abs(32))	#32
import  builtins	 #import builtin module
print(builtins.abs(-25))   #  25

6.

#  max()  and  min()   functions  demo  program
from  builtins  import   max , min       # import max() ,min() functions from built in module
print(max(10.8 , 20.6))                          #20.6
print(min(10.8 , 20.6 , 5.9 , 12.3))	#5.9
print(max(25 , 10.8))		#25
import  builtins			# import built in module in this prog
...
from  builtins  import  pow    # import pow() from the builtin modules
print(pow(10 , -2))                   # 10^-2  ==>  0.01
print(pow(4 , pow(3 , 2)))	#  pow(4, pow(3,2)))-->pow(4,9)-->4^9--->262144
import  builtins		# import built in module into this program
print(builtins . pow(2 , 3))	#(2^3)-->8
print(builtins.pow(-2,-3))      #(-2^-3)---->   (1/-8)--->-0.125
...
print(type(kwlist))
print(keyword.kwlist)              #Error due to keyword is not imported
