# home work question 25/08/2025 pending part 2
...
for  x  in   b:
        print(x) # 10 <next line>  # 10 <next line>   20  <next line>   15 <next line > 18 
...
print(y) # 20 : 'Sita'
print(z) #  15 : 'Rajesh'
print() #  {10 : 'Rama' , 20 : 'Sita' , 15 : 'Rajesh'}
(rno1 , sname1) , (rno2 , sname2) , (rno3 , sname3) = a . items()
a['rno1'] = sname1 # print(rno1 , sname1)
a['rno2'] = sname2 # print(rno2 , sname2)
a['rno3'] = sname3 # print(rno3 , sname3)
# a = {10: 'Rama', 20: 'Sita', 15: 'Rajesh', 'rno1': 'Rama', 'rno2': 'Sita', 'rno3': 'Rajesh'}
...
for p in pairs:
    key, value = p.split('=')
    d[key.strip()] = value.strip()   # remove spaces
print(d)
...
for ch in s:
    if ch not in seen:   # keep first occurrence
        result += ch
        seen.add(ch)
...
print("Enter list with duplicates :", lst)
...
print("Enter 1st list :", list1)
print("Enter 2nd list :", list2)
print("Common elements between the 2 lists :", common_elements)
