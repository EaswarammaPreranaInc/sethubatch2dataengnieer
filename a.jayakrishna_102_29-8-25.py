...
disp(ename = 'Sita' , sal = 20000.0 , empno = 35) # Emp  Number :35  Emp  Name :Sits Salary :20000.0
x = 'Rama  Rao'
y = 30000.0
z = 20
...
#f1(50 , 60) # Error due to '*' operator is defined in fuction header 
#f1(70 , b = 80) # Error due to '*' operator is defined in fuction header 
# #f1(a = 15 , 25)  # Error due to '*' operator is defined in fuction header
...
# Identify error (Home  work)
#def   f1(a  , b , *): # Error * operator should not defined in last
#        pass
