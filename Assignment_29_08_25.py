...
f1(a = 100 , 200 , 300)  #  Error -> Positional argument cannot appear after keyword arguments
...
print(25 , 10.8 , 'Hyd' , endofline = '\t') # invalid keyword argument
...
f1(50 , 60) # f1() takes 0 positional arguments
f1(70 , b = 80) # f1() takes 0 positional arguments
...
# Identify error (Home  work)
def   f1(a  , b , *): # After * one keyword argument should be must
        pass
...
# Identify error (Home  work)
def  f1(/ , a , b ,  c):  # Before slash one positional argument should be must 
        pass
def   f2(a , b , c , *): # After * one keyword argument should be must
        pass
...
disp(40 , 50 , 60 , 70) # Error more arguments
...
print(add(80,90)) # Error 0 positional arguments but 2 were given
