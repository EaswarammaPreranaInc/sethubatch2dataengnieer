...
t=int(input("enter no "))#How  to  read  a  number
a=0
print("Prime Numbers")
...
f1(b = 40.7 , a = 50.2 , c = 60.5) #a : 40.7<tab>b : 50.2<tab>c : 60.5
f1(c = 'Hyd' , b = 'Sec' , a = 'Cyb') #a : Hyd<tab>b : 20<tab>c : 30
f1(c = 3 + 4j , a = True , b = None) #a : 3+4j<tab>b : True<tab>c : None
f1(25 , c = 10.8 , b = 'Hyd') ##a : 25<tab>b : Hyd<tab>c : 10.8
f1(a = 100 , 200 , 300)  #  Error
f1(True , None , b = 'Hyd') # Error due to  b is defind last 
...
y = 30000.0
z = 20
disp(x , y , z)#Emp  Number : Rama Rao<tab>Emp  Name : 30000.0<tab>Salary :20#  Tricky  program
# Find  outputs (Home  work)
def    f1(a , b , c):
    return  a + b * c
#end  of  the  function
...
print(f1({'c' : 2 , 'a' : 4 , 'x' : 6}))#error# Identify  Error (Home  work)
a = [10 , 20 , 15 , 5 , 12]
...
print(25 ,  sep = '\t' , 10.8 , end = '\t' , 'Hyd')  #error# Keyword  only   arguments  demo  program
def   f1(* , a , b):
        print(F'a  :  {a}  \t  b :  {b}')
# End  of  the  function
...
f1(50 , 60)  #error
f1(70 , b = 80)#error
f1(a = 15 , 25)#error#Find  outputs (Home  work)
def  f1(a , * , b , c):
        print(F'a  :  {a}  \t  b :  {b}  \t  c  :  {c} ')
# End  of  function
...
f1(70 , 80 , c = 90)  #error
f1(70 , 80 , 90) #error
f1(c = 15 , b = 25 , 35)  #error# Identify error (Home  work)
def   f1(a  , b , *):  #'*' should be before arguments
        pass#  Positional  only  arguments  demo  program
def   f1(a , b , /):
        print(F'a  :  {a}  \t  b  :  {b}')
# End  of   the  function
...
f1(a = 30 ,  b = 40)#error 
f1(50 , b = 60)#error 
f1(a = 70 , 80)#error# Find  outputs (Home  work)
def  f1(a , b , / , c):
        print(F'a  :  {a}  \t  b :  {b}  \t  c  :  {c} ')
# End  of  function
...
f1(190 , b = 200 , c = 210)#error# Find outputs(Home  work)
def  f1(a , b , / , c , d , * , e  , f):
...
f1(10 , 20 , 30 , 40 , e = 50 , f = 60)#error# Identify error (Home  work)
def  f1(/ , a , b ,  c):#error '/' before there should be atleast 1 argument 
        pass
def   f2(a , b , c , *): #error '*'after there should be atleast 1 argument 
        pass# Identify  error  (Home  work)
def  f4(* , a , b , c , /): #error '/' should be before '*'
...
f1(z = 10)# 10
f1(y = 20) #error
f1(x = 30)#error# Default  arguments  demo  program
def   add(a  , b = 20 , c = 30):
        return   a + b + c
#end  of  the  functiom
print(add(100)) #150
...
print(add(100 ,  b , 300))#error# Identify  Error
def   f1(a = 10 ,  b ,  c = 20 ,  d):#'b' should be before a
	pass
...
f1(20)  #20
f1()  #10
f1(a = 30)#30# Find  outputs (Home  work)
...
print(add())#error#  Find  outputs (Home  work)
def    f1(x = 25):
        return  x
def   f2(x):
        return  x
...
print(f1())#25
print(f2(20))#20
print(f2())#error# Find  outputs (Home  work)
def   disp(ch = '*' , n = 4):
        print(ch *  n)
# End of the function
disp('-' , 6)#------
...
disp(7 , '@')#@@@@@@@@
disp(7 , n = 6)#42
disp(ch = '!' ,  5)#Error# Find  outputs (Home  work)
def  power(a , b  =  2):
        return  a ** b
#end of the function
print(power(2 , 6))  #64
...
disp(80 , 90)#3-argument  function  :   80 90 25# Find outputs(Home  work)
def   add(* , a = 10 , b = 20):
        return  a + b
# End of  the  function
...
print(add(80 , 90))#error# Find  outputs(Home  work)
def   add(a = 10 , b , c):
        pass
def   add( * , a = 10 , b , c ):
        return  a + b + c
