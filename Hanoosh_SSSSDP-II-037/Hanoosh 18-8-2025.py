...
a =  eval(input("Enter a list : "))  #[10 , 20 , 15 , 18 , 19 , 15 , 17 , 20 , 15 , 14] 
b = int(input("Enter a number to be removed : ")) # 15
while b in a:
    a.remove(b)
print(a)
...
a = [25 , 10.8 ,  'Hyd' ,  True]
a . sort() 
# don't give sequence and non-sequence simultaneously
...
if list.count(list[0]) ==len(list):
	...
	print("List elements are not identicals")
