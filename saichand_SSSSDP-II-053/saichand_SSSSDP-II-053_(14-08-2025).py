...
print(a . split('\t'))		# ['Hyd', 'is', 'green', 'city']
print(a . split())		# ['Hyd', 'is', 'green', 'city']
print(a . split(' '))		# ['Hyd <tabspace> is <tabspace> green <tabspace>city']
...
s = input("Enter a string: ")
a = sorted(s)
alpha = ''.join([ch for ch in a if ch.isalpha()])
digit = ''.join([ch for ch in a if ch.isdigit()])
print(alpha + digit)