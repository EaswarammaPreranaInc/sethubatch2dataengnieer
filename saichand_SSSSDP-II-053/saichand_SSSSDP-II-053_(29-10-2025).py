...
def  f1():
	try:
		...
		print('Caught  KeyError')
		raise   NameError()			# NameError is not caught
	except  NameError:
		print('Sec')
	finally:
		print('f1 finally')
...
try:
	print('try')
else:					# Error, after try there should be a except or finally block
    print('else')
finally:
    print('finally')
print('End')
...
try:
	...
	print('else1')
else:					# Error, only one else we can use
	print('else2')
finally:
	print('finally')
print('end')
...
t2 . start()
print(active_count())
print('Press  ctrl + break  or  Fn + b  to  stop ')		# continuous loop
...
#Sample Output:
Sita  guess  50   in  attempt  :  n
Sita  finish  in  n  attempts
Rama  guess  75   in  attempt  :  m
Rama  finish  in  m  attempts
...
#Output: (output cannot change for each run)
new thread 10 times
...
#Output: (output may change for each run)
new thread 10 times (after each run it will stop for 2 sec, due to sleep)
main thread 10 times
...
#Sample Output: (output cannot change for each run)
Double :  2 to 12 (6 times)
Square :  1 to 36 (6 times)
time taken to run
...
Three  is  started
4
(sleep for 3 seconds, after the output may change for each run)
threads are ended
count
