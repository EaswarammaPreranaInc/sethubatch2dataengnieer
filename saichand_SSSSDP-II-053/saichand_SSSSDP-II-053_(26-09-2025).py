...
print(s . _dict_)			# {}
s . get()
print(s . _dict_)			# It takes the inputs from user
s . compute()
print(s . _dict_)			# Dictionary of the given inputs are printed
...
print(dir(Rat))				# [ list of attributes and methods,  'add', 'div', 'get', 'mul', 'simplify', 'sub', 'test']

print()

print()

print(dir(a))				# [ list of attributes and methods, 'add', 'div', 'dr', 'get', 'mul', 'nr', 'simplify', 'sub', 'test']
...
dict = {'Empno': 25, 'Ename': 'Rama Rao', 'Sal': 10000.0}
e = Emp()
setattr(e, 'Empno', dict['Empno'])
setattr(e, 'Ename', dict['Ename'])
setattr(e, 'Sal', dict['Sal'])
print(f"Empno : {getattr(e, 'Empno')}")
print(f"Ename : {getattr(e, 'Ename')}")
print(f"Sal   : {getattr(e, 'Sal')}")
