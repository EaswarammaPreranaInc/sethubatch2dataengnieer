...
How  to  print  each  inner  list  of  list  'a'  without  using  indexes  (use  for  loop)				# for sublist in a:
															       print(sublist)
print('Elements  in  the  form   of  matrix   without  using  indexes')							# Elements  in  the  form   of  matrix   without  using  indexes
How  to   print  elements  of  each  inner  list  without  using  indexes  in  matrix style  (use  nested  loop)	# for sublist in a:
															       for element in sublist:
															           print(element, end=' ')
															       print()
print('Elements  in  the  form   of  matrix  using  indexes')								# Elements  in  the  form   of  matrix  using  indexes
How  to   print  elements  of  each  inner  list  using  indexes  in  matrix style (use  nested  loop)			# for i in range(len(a)):
...
for  x  in  a:
	print(x)
for  x , y  in  a:				# Error, there are only x,y but the elements are more
	print(x , y ,	sep = '...')
...
print(How  to  print  inner  list  in  another  way)		# using loops
