...
from p1.mod1 import x as x_mod1, f1 as f1_mod1, c1 as c1_mod1           # How  to  import   members  of  mod1   in  package  p1  with  from  statement
from p1.mod2 import x as x_mod2, f1 as f1_mod2, c1 as c1_mod2           # How  to  import   members  of  mod2   in  package  p1  with  from  statement
print(x_mod1)                   					# How  to  print  object  'x'  of   mod1  in  package  p1
f1_mod1()                       					# How  to  call  function  f1()  of   mod1  in  package  p1
a = c1_mod1()
a.m1()                          					# How  to  call  method  m1()  of   class  c1  in  mod1  of  package  p1
print()
print()
print(x_mod2)                   					# How  to  print  object  'x'  of   mod2  in  package  p1
