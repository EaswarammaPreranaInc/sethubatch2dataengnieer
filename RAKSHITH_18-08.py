...
a = [[10 , 20 , 15 , 18]]
#print(sum(a))   # error 
print(sum(a[0]))    #63 #How  to  determine  sum  of  inner  list  elements
print(sum(x for x in a[0])) # 63 #How  to  determine  sum  of  inner  list  elements  in  another  way
...
print(min(b))   #Amar
c = [25 , 10.8 ,  3 + 4j , True]
print(max(c))   # Error not support between operands complex and list
d = [25 , '35']
print(max(d))   # Error not support between operands string and int
...
a = list()
print(a)    # []
print(list(25))     # [25] int object not iterable
print(list(10.8))   # 10.8  float object not iterable
print(list(True))   # True  bool object not iterable
print(list(None))   # None  Nonetype  object not iterable
...
a = [25 , 10.8 ,  'Hyd' ,  True]
a . sort()      # Error not support between str and float
...
if x.count(x[0])==len(x):
    ...
    print('Lsit elements are not identical')
