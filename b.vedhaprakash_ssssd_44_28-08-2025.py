# module 2 homeworks 
# homework on 28-08-2025 ANSWERES 
...
def   f1():
        print('Hello')
print(f1()) #Hello
print(f1) # <class 'str'> and address of f1 class
...
print(f1()) # f1  function
            # None
print(f1) # <function f1 at 0x10e281d30>
print('Bye') # Bye
-------------------------------------------------------------------------------------------
...
# End  of  the  function
disp(25 , 'Rama  Rao' , 10000.0) # {empno:25,Emp Name : Rama Rao , sal : 10000.0}
