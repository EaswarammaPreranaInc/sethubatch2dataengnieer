...
try:
	print('try')
#else: # Error due 'Try' suite followed by Except or Finally suite bolck
    print('else')
finally:
    print('finally')
print('End')
...
try:
	...
	print('else1')
#else: Error due to only one else suite is followed by try,except suites of blocks
	print('else2')
finally:
	print('finally')
print('end')
...
''' (Home  work)
1) What  is  the  output  when  input  is  24 ?  ---> # blank space
                                                        End
...
t=Thread(target,name="new")  #How  to  create  a  new  thread  with  name  'new'   and  target  f1
...
print("New Name of Main Thread :",current_thread().name) # How  to  print  name  of  main  thread
print("New Name of Thread t1:",t1.name) # How  to  print  name  of  thread  t1
print("New Name of Thread t2 :",t2.name) # How  to  print  name  of  thread  t2
...
Hyd : 10
Sec : 20
above two statements will be print infinity times
...
# Output :
Rama  guess  97   in  attempt  :  1
Rama  guess  88   in  attempt  :  2
Sita  guess  69   in  attempt  :  1
Sita  guess  22   in  attempt  :  2
Rama  guess  45   in  attempt  :  3
Sita  guess  40   in  attempt  :  3
Sita  guess  89   in  attempt  :  4
Rama  guess  56   in  attempt  :  4
Sita  guess  75   in  attempt  :  5
Rama  guess  58   in  attempt  :  5
Sita  guess  83   in  attempt  :  6
Rama  guess  71   in  attempt  :  6
Sita  guess  43   in  attempt  :  7
Sita  guess  73   in  attempt  :  8
Rama  guess  9   in  attempt  :  7
Sita  guess  64   in  attempt  :  9
Rama  guess  63   in  attempt  :  8
Sita  guess  50   in  attempt  :  10
Rama  guess  89   in  attempt  :  9
Rama  guess  57   in  attempt  :  10
Sita  finish  in  10  attempts
Rama  guess  43   in  attempt  :  11
Rama  guess  75   in  attempt  :  12
Rama  finish  in  12  attempts
