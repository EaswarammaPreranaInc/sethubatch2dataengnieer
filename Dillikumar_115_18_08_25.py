...
print(How  to  determine  sum  of  inner  list  elements  in  another  way)
 ...
 SSSC: # max()  and  min()  functions  demo  program  (Home  work)
...
'''
[18/08/2025 11:32] SSSC: # list()  function  demo  program
a = (10 , 20 , 15, 18)
b = list(a)
print(b)  : [10 , 20 , 15, 18]
...
SSSC: # sorted()  function   demo  program
a = [10 , 20 , 15 , 5 , 12]
b = sorted(a)
...
4) What  are  the  two  arguments  of  sorted()  function ?  --->  List  to  be  sorted
						and			                  reverse = True  which  is  an  optional  argument
'''
[18/08/2025 11:35] SSSC: # Find  outputs  (Home  work)
...
dup=[]
ipt=int(input("enter element to be deleted "))
for i in a :
   if i !=ipt:
       dup.append(i)
print(dup)
...
list . clear()
print(list) : [] empty list will printed 
...
a = [25 , 10.8 ,  'Hyd' ,  True]
a . sort()   : error , no printig statmet and no num and string comparision 

#  count()  method  demo    program (Home  work)
a = [10 , 20 , 15 , 18 , 15 , 12 , 14 , 15 , 19]
print(a . count(15))  : 3 times 
print(a . count(25))  : 0
print(len(a))         : 9 times 
...
try:
	...
	print(f"15  is repeated  {a .count(15)}times ")
