...
#  Find  outputs  (Home  work)
def  f1(b):
	b[2] = 25 #Error because it is  tuple
#end  of  the  function
a = (10 , 20 , 15 , 18)
print(a) #(10, 20, 15, 18)
f1(a)  #Error
...
print( lambda   x  :  x * x(7)) # return type and address
print( lambda   x  :   x * x) # return type and address
...
print(add()) # Error
print(add) # return type and address
...
print(lambda  x , y : x + y ('Hyder' , 'abad')) #function address
...
print(a)  #id and address of f1 f2
