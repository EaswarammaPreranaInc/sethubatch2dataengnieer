...
tpl = (100 , 200 , 150)
f1(tpl)
f1(t = (10 , 20 , 30))          # error f1() can't be a keyword argument
...
f1()                                    # a:25  b:()
f1(a = 10 , (20 , 30 , 40))             # error positional argument followed by keyword argument
f1(25 , b = (10 , 20 , 30))             # error f1() has multiple values for b
f1(25 , a = (10 , 20 , 30))             # error f1() has multiple values for a
f1((10 , 20 , 30) , 10 , 20 , 30)       # a:(10,20,30)  b:(10,20,30)
f1(a = (10 , 20 , 30) , 10 , 20 , 30)   # error positional argument followed by keyword argument
