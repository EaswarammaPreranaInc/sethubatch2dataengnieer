...
d = a
print(d)           # [10, 20, 15, 18]
print(a is d)      # True, both point to same object
print(a == d)      # True, contents are same
...
print(a)              # How to print complete nested list
print(len(a))         # How to print number of inner lists
...
print(a)      # Directly printing the whole nested list
...
for x, y in a:
    print(x, y, sep='...')   # 10...20
                             #  ERROR (too many values to unpack in [30, 40, 50])
                             # program stops here
...
print(sorted(a))                 
# [[5, 'Amar', 5000.0], [10, 'Rama', 1000.0], [15, 'Rajesh', 3500.0],
#  [18, 'Kiran', 2800.0], [20, 'Sita', 2000.0]]

print(sorted(a , reverse = True)) 
# [[20, 'Sita', 2000.0], [18, 'Kiran', 2800.0], [15, 'Rajesh', 3500.0],
#  [10, 'Rama', 1000.0], [5, 'Amar', 5000.0]]

print(a)                          
# [[10, 'Rama', 1000.0], [20, 'Sita', 2000.0], [15, 'Rajesh', 3500.0],
#  [18, 'Kiran', 2800.0], [5, 'Amar', 5000.0]]
