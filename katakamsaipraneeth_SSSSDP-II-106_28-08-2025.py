...
a = [ ('R' , 'Red') , ('G' , 'Green') , ('B' , 'Blue')] # list obj
b = {'Y' : 'Yellow', 'G' : 'Gray'} # dict obj
b . update(a) # dict is modified with list
print(b) # {'Y' : 'Yellow', 'G' : 'Green', 'R' : 'Red' , 'B' : 'Blue'}
a . update(b) # error 


#  Find  outputs  (Home  work)
a = [ (10 , 20 , 30) , (40 , 50 , 60) , (70 , 80 , 90)] # nested list of tuple
b = {} # empty dict obj
b.update(a) # error
print(b) # error
c = [(10,) , (20,) , (30,)] # list obj
...
############## program ###########3333
def prime(s):
    for i in range(2, s//2 + 1):   # check divisors from 2 up to s//2
        if s % i == 0:
...
# Find  outputs  (Home  work)
def   disp(empno , ename , sal): # fun header
