...
''' count()  method  demo  program (Home  work) 5
...
'''
a = 'babble'  # input string
first_char = a[0]  # store first character
result = first_char + a[1:].replace(first_char, '*')
print(result)



#  Find  outputs  (Home  work) 8
a = '15:36:48'
...
'''
expr = '123+45+6+789' 
total = sum(int(num) for num in expr.split('+'))
print(total) # 963



#  Find  outputs  (Home  work)  14
a = ['15' , '36' , '48']
...
# endswith()  method  demo  progrram (Home  work)   15
a = 'Hyd is green city'
...
#  isalpha()  method  demo  program (Home  work)    17
...
# isdigit()  method  demo  program  (Home  work)    18
...
# isupper()  method  demo  program  (Home  work)     19
...
# islower()  method  demo  program  (Home  work)        20
...
# isalnum()  method  demo  program  (Home  work)     21
...
# isspace()  method  demo  program  (Home  work)        22
print('\n  A\t' . isspace())  #  False
print('\n  \t' . isspace()) #  True
print('\n  7\t' . isspace())  # False
print('\n' . isspace())  # True
