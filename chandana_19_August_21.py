...
a += b # # creates a new tuple by concatenation and id changes
...
b = (4,5,6)
print(a , id(a)) # (1,2,3)  Address of 'a'
a = a + b # creates a new tuple by concatenation and id changes
print(a , id(a)) # (1,2,3,4,5,6) Address of'a'

# outputs  if  input  is  (10 , 20 , 30 , 40) 
...
#a[1] = [80 , 90 , 100] # cannot modify tuple elements
print(a) #  (10, [70, 30, 40], 50, 60)
