...
a = Rat()
b = Rat()
c = Rat()  				# Create 3 objects

print("Enter 1st rational number:")
a.get()					# Input first rational number



print("Enter 2nd rational number:")
b.get()						# Input second rational number
print("Addition result", c.add(a, b))		# Addition
print("Subtraction result", c.sub(a, b))	# Subtraction
print("Multiplication result", c.mul(a, b))	# Multiplication
c.div(a, b)					# Division
if c.den != 0:
