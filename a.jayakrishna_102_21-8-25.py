...
a = (1,2,3)
b = (4,5,6)
print(a , id(a)) # (1,2,3) 123456789
a += b
print(a , id(a)) # (1,2,3,4,5,6) 12453679
...
a = (1,2,3)
b = (4,5,6)
print(a , id(a)) # (1,2,3) 12345674
a = a + b
print(a , id(a)) # (1,2,3,4,5,6) 1245367932
...
a[1] = [80 , 90 , 100]
print(a) # Error due to tuple dont support 
