...
print('x : ' , x)      					#x: Hyd
print('y : ' , y)      					#y: True
for  x  in  list[2:7]:					#3+4j<next line>Hyd<next line>True<next line>None<next line>10.8
	print(x)
...
a = {25 , True , 'Hyd' , 10.8}
print(a)              						#How to print set  with  print  function
print('Iterate  thru  set  with  for  loop')
for i in a:									#How  to  iterate  thru  set  with  for  loop
	print(i)
