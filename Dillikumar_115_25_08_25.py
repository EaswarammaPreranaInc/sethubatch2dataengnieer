...
result = list(set(list1) & set(list2))   # intersection
...
print(a[Rama Rao]) # How  to  print  'Rama Rao'  in  dict  'a')
print(a[Sal])    # How  to  print  value  1000.65   in  dict  'a')

# How  to  modify  values  of  dictionary  (Home  work)
a  =  {'Empno'  :  25,  'Ename'  :  'Rama  Rao'  ,  'Sal'  :  1000.65  }
print(a)  # {'Empno'  :  25,  'Ename'  :  'Rama  Rao'  ,  'Sal'  :  1000.65  }
print(id(a))  # 140709627787584
a[Sal]=2000
print(a)
...
a  =  {'Empno'  :  25,  'Ename'  :  'Rama  Rao'  ,  'Sal'  :  1000.65  }
print(a) # {'Empno': 25, 'Ename': 'Rama Rao', 'Sal': 1000.65, 'Gender': 'Male', 'Married': True} 
...
'''
[25/08/2025 11:56] SSSC: How many Employees ? : 4
Enter Emp Name : AAA
Enter Salary : 100000
Enter Emp Name : BBB
Enter Salary : 200000
...
pairs = s.split(",")     # split into parts by comma
for p in pairs:
    k, v = p.split("=")  # split each part by =
    a[k.strip()] = v.strip()
...
b = dict(sorted(a.items()))    # sorting by keys
