#Tarun banala(089)       Thread creation and rigister into thread sheduelor            28-10-2025
'''
Tricky  program
...
t1 . start() #  What  does  thread  t1  do ? f1  function
t2 . start()  #  What  does  thread  t2  do ?m1  method  of  class  c1
t3 . start()   #  What  does  thread  t3  do ?
t4 . start()   #  What  does  thread  t4  do ?run   method  of  MyThread  class
t5 . start()   #  What  does  thread  t5  do ? run   method  of  MyThread  class
t6 . start()  #  What  does  thread  t6  do ?f1 function 
t7 . start() #  What  does  thread  t7  do ?
t8 . start()   #  What  does  thread  t8  do ?m1  method  of  class  c1
t9 . start()   #  What  does  thread  t9  do ? #m1  method  of  class  c1
t10 . start()  #  What  does  thread  t10  do ?#run   method  of  MyThread  class
t11 . start()   #  What  does  thread  t11  do ? error
t12 . start()  #  What  does  thread  t12  do ? #m1  method  of  MyThread  class
t13 . start()   #  What  does  thread  t13  do ?f1  method  of  class  c1
...
class  MyThread(Thread):
	...
	def   run(self):
		print('Run Method')
child = MyThread() 
child . start() #start method, run method
...
print('Names of Threads',t1.name,t2.name,t3.name)
