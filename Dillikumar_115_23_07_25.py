...
print(math . floor(25.0))   : 25.0
print(math . ceil(25.0))   : 25.0
...
print(floor(3.5))  : error , i.,e without  math function not possible fr calculation 
...
print(gcd(5 , 15))               : error necause no function definition is there 
...
print(builtins . pow(-2 , -3))  : -(1/2^3) = -0.125
