...
all
----------
1) What is all ? ---> List of members of the module which are to be imported when * is used

2) from cal import *
    Which members are imported ? ---> Those members which are in all list of cal module

3) What happens when all list has an invalid member ? ---> from module import * throws ImportError

4) Where is all list defined ? ---> Inside the module i.e. Any where in the module

5) from cal import *
    Which members are imported when all list is not defined in cal module ? --->
          All the members are imported becoz default all is every member of the module

6) from cal import *
    Which members are imported when all list is empty in cal module ? ---> No member is imported

7) from cal import y , sub , mul
    Which members are imported ? ---> y , sub and mul but not members of all list

8) all list plays a key role only when * is used in import clause of from statement
