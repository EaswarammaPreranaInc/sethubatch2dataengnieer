...
ob = triangle()  					#  to  create  triangle  class  object
ob.get(a, b, c)    					# to  read  inputs  into  object
ob.test()    						# to  test  whether  inputs  are  valid
print('Area : ',  ob.area())
