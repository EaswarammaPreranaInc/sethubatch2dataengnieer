...
def  f1(b):
    pass
	#b[2] = 25  #  Error due to tuple not have item assignment
#end  of  the  function
a = (10 , 20 , 15 , 18)
...
print( lambda   x  :  x * x(7))  #  Function name and address
print( lambda   x  :   x * x)   #  Function name address
...
print(add(10 , '20'))  #   Error due to int , str cannot be added
print(add())  #  Error due to missing values x,y
print(add)  #  function name and address
...
print(lambda  x , y : x + y  ('Hyder'  ,  'abad'))  #  Function name and Address 
...
#  Find  outputs  (Home  work)
s = 'Hyd'
print(lambda  s  :  print(s))  #  Function name and address
print(lambda  x  :  print(x) (s))  #  Function name and address
print((lambda  x  :  print(x)) (s))  # Hyd return None
...
for  x  in  a:
	     x()  #  Hyd  Sec
a = [def   f1():  print('Hyd') ,  def   f2():  print('Sec')]  #  Error due to Invalid Syntax
print(a)  #  [Hyd,Sec]
...
print(lamb())  #  Error due to give function values
...
print(sorted(a , key = x[1]))  #  Error due x is not defined
...
print(add())  #  Function name and address
add = lambda  x  :   x = 25  #  Error due to values cannot add to lambda
