...
z = x + y * 6			#34
print(z)
25 = a				#Object cannot be used as Reference
a + b = x + y			#Error:Expression cannot be used as reference
...
print(id(b))			#prints same address
print(id(c))			#prints same address
