...
# Identify error (Home  work)
def   f1(a  , b , *): # Atleast one arg is req after *
        pass
...
print(add()) # Error
print(add(a = 100 , 200)) # Error PA's followed by KA's
...
def   f1(a = 10 ,  b ,  c = 20 ,  d):
	pass # Error due to default args should write after normal args
...
print(add(c = 100 , d = 200 , 300 , 400)) # Error due PAs followed by KAs 
