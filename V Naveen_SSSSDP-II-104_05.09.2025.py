...
print( lambda   x  :  x * x(7)) # <function <lambda> at some address 5000
print( lambda   x  :   x * x) # <function <lambda> at some address 5000
...
print(add()) # Error
print(add) # < function 'lambda' > at some address 0x2000
...
print(lambda  x , y : x + y  ('Hyder'  ,  'abad')) # < function 'lambda' > at some 0x5
...
a  =  lambda  :  'Hyd'
print(a()) # Hyd
print(a) # < function 'lambda' at 0x5690000
...
print(a) # (<function <lambda> at 0x000001891341F740>, None, None)
for  x  in  a:
	print(x) 
	''' 
	<function <lambda> at 0x000001891341F740>
	None
	None
	'''
a() # Error
...
s = 'Hyd'
print(lambda  s  :  print(s)) # <function <lambda> at 0x0000018913440D60>
print(lambda  x  :  print(x) (s)) # <function <lambda> at 0x0000018913440D60>
...
print(a) # [<function f1 at 0x 0040000>, <function f2 at 0x005000 ]
...
key = 'power_3'
print(a[key]) # < function 'lambda' at 0x0060000 >
print(a[key](5)) # 125
...
print(lamb(2)) # 9
print(lamb(5)) # 243
print(lamb) # < function f1.'locals'.'lambda' at 0x02000 >
print(lamb()) # Error
