...
def  change(b):
	b . append(25)          # add 25 to list
	b[2] = 17               # index 2 is modified to 17
	del  b[1]               # deletes index 1
# End  of  the  function
a = [10 , 20 , 15 , 18]
print(a)                    # [10,20,15,18]
change(a)
...
#  Find  outputs  (Home  work)
def  f1(b):
	b[2] = 25                           # tuple cannot be modified
#end  of  the  function
a = (10 , 20 , 15 , 18)
print(a)                                # (10,20,15,18)
f1(a)
...
print(add(25 , 10.8))               # 31.8
print(add(3 + 4j , 5 + 6j))         # (8+10j)
print(add(10 , '20'))               # Error int and string cannot be concatenated
print(add())                        # Error there are no values
...
#  Find  outputs  (Home  work)
s = 'Hyd'
print(lambda  s  :  print(s))           # <function 'lambda'>
...
print(sorted(a , key = x[1]))                   # Error not defined
