...
##########################
SyntaxError: 'else' without 'except'
...
two else blocks cause a syntax error before running the program.
...
#######################################
Rama guess 17 in attempt : 1
Sita guess 83 in attempt : 1
Rama guess 75 in attempt : 2
Rama finish in 2 attempts
Sita guess 50 in attempt : 5
Sita finish in 5 attempts
...
Two threads (t1 for 7 and t2 for 4) run concurrently.

Output is interleaved — both tables print at the same time, not one after another.

Exact order depends on thread scheduling.

its not exact may possible:-
