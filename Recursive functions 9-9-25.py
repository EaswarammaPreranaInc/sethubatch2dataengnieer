...
'''
1) power(4.5 , 3) = 4.5*pow(4.5,2) --> 4.5 * 4.5*pow(4.5,1) ---> 4.5 * 4.5 * 4.5 * pow(4.5 , 0) ---> 4.5 *4.5*4.5*1

2) power(4.5 , -3) =1 \ 4.5*pow(4.5, -2) --> 1 / 4.5 * 4.5*pow(4.5,-1) ---> 1 / 4.5 *1 / 4.5 *1 / 4.5 * pow(4.5 , 0) ---> 1\4.5 * 1\4.5 * 1\4.5*1
...
def  rev(n):
	if n == 0:
		...
		return (n % 10) * int(pow(10 , len(str(n)) - 1)) + rev(n // 10)
'''
rev(946)  =  646
'''
