...
f1(3)                                               # [3] is appended to list
print('_defaults_  :  ' , f1._defaults_)            # ([3],)
f1(4 , [1 , 2 , 3])                                 # [1,2,3,4] ia appended to list
print('_defaults_  :  ' , f1._defaults_)            # ([3],)
f1(9)                                               
...
print(f1(3))                                        # 0*0,1*1,2*2 are appended to default list
...
print('_defaults  :  ' , f1._defaults_)             # [0,1,4,0,1,4,9,16]
print(f1(6))                                        # 0,1,4,9,16,25 are appended to the defalut list
