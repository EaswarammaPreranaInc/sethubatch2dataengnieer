...
Ans) class Student:
    def get(self):
        ...
        self.m=[]
for in range(3):
	marks = in(input(f’Enter marks of subject (i+1) : ‘)
	self.m.append(marks)
    def compute(self):
...
print(c._str_())       # How to print object 'c'  # Output example: 11 / 9
print(d._str_())       # How to print object 'd'  # Output example: 1 / 9
print(e._str_())       # How to print object 'e'  # Output example: 10 / 27
if f.num is not None:  # Check if division is valid
    print(f._str_())   # How to print object 'f'  # Output example: 6 / 5
else:
