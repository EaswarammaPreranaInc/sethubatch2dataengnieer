...
print("End")
"""
infinite loop due to local variable 'a'
"""
...
True
f1 function
None #becoz of print func not returning
"""
...
p("hyderabad")
print = None
print("Hello")  # Error becoz print points to 'None'
