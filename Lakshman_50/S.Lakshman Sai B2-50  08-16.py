...
print(a + 5)    #Error because 5 can't add into a list
print(a + '5')    #Error because '5' can't add into a list
print([10 , 20] + (30 , 40))
...
a += b
print(a , id(a))       # [1, 2, 3, 4, 5, 6]  address of same a
...
print(a , id(a))    # [1, 2, 3]  address of a
a  = a + b
print(a , id(a))    # [1, 2, 3, 4, 5, 6]  address of new a
...
print('q : ' , q)     # q : True
 ...
 # Find  outputs  (Home  work)
list = [25 , 10.8 , 'Hyd' , True]
a , b , c , d , e = list   #error because there are only 4 elements in the list
...
list = [25 , 10.8 , 'Hyd' , True , 3 + 4j]
a , *b , c , *d , e  = list   #Error because of multiple unpacking
