...
a = (1, 2, 3)
b = (4, 5, 6)
print(a, id(a))  # (1, 2, 3) adress of a
a += b
print(a, id(a))  # (1, 2, 3, 4, 5, 6) new adress of a
...
print(c)  # Hyd
print(d)  # True
p, q, r = x  # Error because not enough values to unpack
a, b, c, d, e = x  # Error because too many values to unpack

# ***************************************************************************
# Find  outputs   (Home  work)
x = 25, 10.8, "Hyd", True
a, *b, c = x  # a = 25, b = [10.8, 'Hyd'], c = True
print(a)  # 25
print(b)  # [10.8, 'Hyd']
print(c)  # True
...
e = tuple("Vamsi")
print(e)  # ('V', 'a', 'm', 's', 'i')
print(tuple(25))  # Error because argument must be a sequence
print(tuple())  # ()
