...
b = {30 , 40 , 50 , 60}
c = a . intersection(b)
print(c)       # {40, 30} order may vary
print(type(c))   # <class 'set'>
d = a & b                 
print(d)          # {40, 30}   order may vary
...
b = {30 , 40 , 50 , 60}
c = a . difference(b)
print(c)               # {10, 20}  order may vary
print(type(c))         # <class 'set'>
d = a - b                
print(d)               # {10, 20}    order may vary
print(type(d))         # <class 'set'>
print(c  is  d)        # False
print(c  ==  d)           # True
...
print(c)          # {50, 20, 10, 60} order may vary
print(type(c))       # <class 'set'>
d = a ^ b
print(d)               # {50, 20, 10, 60} order may vary
print(type(d))         # <class 'set'>
print(c   is   d)       # False
print(c  ==   d)        # True
...
print(a)              # {0, 1, 4, 9, 16, 25, 36, 49, 64, 81} order may vary              
...
print(a['Empno'])  # prints value 25 in dict 'a'
print(a['Ename'])
print(a['Sal'])
...
a = {10 : 20 , 30 : 40}
b = {30 : 50 , 10 : 60}
print(a + b)       #Error becoz  +  operator  is  not  defined  for  dictionaries          
c = {**a , **b}
print(c)                   # {10 : 60 , 30 : 50}   order may vary
d = a | b          
print(d)             # {10 : 60 , 30 : 50}   order may vary
...
print(sum(a))           # 90
print(sum(a . items())) # Error becoz  items()  returns  list  of  tuples
...
print(dict(h))      #Error becoz  unhashable  type:  'list'
...
a . clear()    # removes  all  key : value  pairs  from  dictionary  'a'
print(a)       # { }
del  a        # deletes  dictionary  'a'
print(a)     # Error  becoz  'a'  is  not  defined
...
b = a . copy()           # creates  a  shallow  copy  of  dictionary  'a'
print(b)            # {'R' : 'R ed' , 'G' : 'Green' , 'B' : 'Blue'}
print(a  is  b)      # False
print(a  ==  b)      # True
...
b = a . keys()      # returns  all  the  keys  of  dictionary  'a'
print(b)       # dict_keys([10, 20, 15, 18])
print(type(b))     # <class 'dict_keys'>
for  x  in   b:              
        print(x)           # prints  each  key  in  a  new  line    
...
for  x   in   b: 
	print(x)       # prints  each  value  in  a  new  line
...
for  x   in   b: 
        print(x)                  # prints  each  tuple  in  a  new  line
for  x , y   in  b:
        print(x , y , sep = ' ... ')   # prints  each  key  and  value  in  a  new  line
...
for  x , y   in  a . items():
       print(x , y , sep = ' ... ')   # prints  each  key  and  value  in  a  new  line
for  x , y   in  a . keys():          
       print(x , y , sep = ' ... ')  # Error  becoz  keys()  returns  only  keys  but  we  are  trying  to  unpack  two  values
for  x , y   in  a . values():
       print(x , y , sep = ' ... ')  # Error  becoz  values()  returns  only  values  but  we  are  trying  to  unpack  two  values
for  x , y   in  a:
       print(x , y , sep = ' ... ')      # Error  becoz  iterating  dictionary  returns  only  keys  but  we  are  trying  to  unpack  two  values
...
print(rno2 , sname2)     # 15 Rajesh
print(rno3 , sname3)         # 20 Sita
