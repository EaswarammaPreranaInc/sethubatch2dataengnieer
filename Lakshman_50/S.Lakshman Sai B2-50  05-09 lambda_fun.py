...
a = (10 , 20 , 15 , 18)
print(a) #(10, 20, 15, 18)
f1(a)  #Error becoz of tuple is immutable
print(a)
...
print( lambda   x  :  x * x(7)) #address 
print( lambda   x  :   x * x)        #address same as above lamda func becoz ther is no ref for above lamda func 
												#			so, above lambda func will lost so address may be same or different
...
print(add(25 , 10.8))
print(add(3 + 4j , 5 + 6j))
# print(add(10 , '20'))#error becoz int and str never concat
# print(add())#no argu to pass
print(add)
'''
<class 'function'>
30
...
<function <lambda> at 0x00000217A0400E00>
'''
#***********************************************************
...
31.400000000000002
Hyderabad
<function <lambda> at 0x000001D86F6C1440>
'''
...
Cyb
<class 'tuple'>
(<function <lambda> at 0x0000023E29CE1440>, None, None)
'''
for  x  in  a:
	print(x)
a()  #Error
print(a[0]()) #print(lambda )
'''
Hyd
None
'''
...
(lambda  x  :  print(x)) (s)
'''
<function <lambda> at 0x0000026E4A921440>
<function <lambda> at 0x0000026E4A921440>
Hyd
...
print(a[key](5))
'''
<function <lambda> at 0x00000146C9F20E00>
125
'''
...
print(lamb(5))
print(lamb)
print(lamb()) #error becoz argu not passed
'''
<class 'function'>
<class 'function'>
9
243
<function f1.<locals>.<lambda> at 0x00000200EBF10E00>
'''
...
print()
d = sorted(a ,  key =  lambda   x  :  x[1]) #[(5, 'Amar', 1300.0), (18, 'Kiran', 2800.0), (15, 'Rajesh', 500.0), (10, 'Rama', 1000.0), (20, 'Sita', 2000.0)]
print(d)
print()
e = sorted(a , key =  lambda   x  :  x[2]) #[(15, 'Rajesh', 500.0), (10, 'Rama', 1000.0), (5, 'Amar', 1300.0), (20, 'Sita', 2000.0), (18, 'Kiran', 2800.0)]
print(e)
print()
f = sorted(a , key = lambda   x  :  x[0]) #[(5, 'Amar', 1300.0), (10, 'Rama', 1000.0), (15, 'Rajesh', 500.0), (18, 'Kiran', 2800.0), (20, 'Sita', 2000.0)]
print(f)
print()
g = sorted(a , key = lambda  x : x[1] , reverse = True) #[(20, 'Sita', 2000.0), (10, 'Rama', 1000.0), (15, 'Rajesh', 500.0), (18, 'Kiran', 2800.0), (5, 'Amar', 1300.0)]
print(g)
print(sorted(a , key = x[1])) #Error becoz there no 'x' to call
...
def matchStick(m):
	while m>2:
		user=int(input("enter the num b\w 1-5: "))
		if user>=5 or user <=0:
			print("enter the user inpput b\w 0-5")
			continue
		else:
			print(f"user input is: {user}")
			print(f'comp input is: {5-user}')
			m-=5
...
a=[]
num=''
roman_num=input("enter the romman num: ")
val={'I' : 1  ,'IV' : 4 , 'V' : 5 , 'X' : 10 , 'L' : 50 , 'C' : 100 ,  'D' : 500 , 'M' : 1000}
roman_to_num()
