...
a[3] = 'Sec'    # Error tuple doesn't allow item assignment
a[3 : 6] = 60 , 70 , 80     # Error tuple doesn't allow item assignment
...
a[1] = [80 , 90 , 100]  # Error tuple doesn't allow item assignment
print(a)    # print function doesn't execute due   to Error

# Find  outputs  (Home  work)
a = [10 , (20 , 30 , 40) , 50 , 60]
a[1][0] = 70    # Error tuple doesn't allow item assignment
...
e = tuple('Vamsi')
print(e)    # ('V','a','m','s','i')
#print(tuple(25))    # Error argument should be sequence
print(tuple())  # ()
