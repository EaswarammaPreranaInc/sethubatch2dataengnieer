...
print(tuple(list(a))) # (10,20,30,40,50)
print(a[:2] + (35,)+a[3:])#How  to  modify  30  in  tuple  to  35
print(a) # (10,20,35,40,50)
print(id(a)) # address of updated tuple

# How  to  delete  an  element  of  tuple ?   (Home  work)
a  = 10 , 20 , 30 , 40 , 50
#    0     1      2     3      4
a.remove(30) # Error because tuple does not have remove method
del  a[2] # not possible
a.pop(2) # Not possible
print(a) #(10,20,30,40,50)
print(id(a)) # Address of object a
print(a[:2]+a[3:]) #How  to  remove  30  from  tuple  'a'
print(a) # (10,20,40,50)
...
b = eval(a) # set 
print(b) # same elements but not in order any order and no duplicates {18, 20, 10, 12, 15}
...
e = 'Hyd'
s = {a , b , c , d , e}
print(s) # set without duplicates in any order
print(len(s)) # 3
print(type(s)) # <class 'set'>

# Find  outputs  (Home  work)
s = {'Hyd',  25,  True,  10.8 }
print(s) # {'Hyd',  25,  True,  10.8 } but any order not exactly this order
a , b , c , d = s
print(a) # 'Hyd'
print(b) # 25
print(c) # True
