...
############## program #############
a = eval(input("Enter  list  of  lower  case  strings :"))
b = [x[0].upper() for x in a] # list comprehension
print(b)
...
'''
############## program #################
a = [i*i for i in range(1,21) if i % 2 == 0]
...
b = [ x  for  x  in  a  for  y  in  x] # list comprehension
