...
s=input('Enter string : ')  # Rama Rao
d=set(s)
c=''.join(d)
print(f"String without duplicates : {c}")   # oa mR
...
l=eval(input('Enter list with duplicates: '))   # [False , 25 , 10.8 , 1  , 25 , 0 , 'Hyd' ,  10.8 , 1.0 , None , 'Sec' , 'Hyd' , True ]
l1=[]
for i in set(l):
    l1.append(i)
print(f"List without duplicates : {l1}")    # [False, 1, None, 'Sec', 10.8, 25, 'Hyd']
...
l1=eval(input('Enter 1st list : ')) #  Enter 1st list : [10 , 20 , 30 , 40 , 50 , 60]  
l2=eval(input('Enter 2nd list : ')) # Enter 2nd list : [30 , 40 , 70 , 80 , 20]
l3=[]
for i in set(l1):
    if i in l2:
        l3.append(i)
print(f'Common elements between the two lists : {l3}')  # Common  elements  between  the  2  lists :   [40, 20, 30]
...
print(id(a))    # Address of the dictionary 100000
...
print(id(a))    # Address of the same dictionary 100000
...
d={}
for i in range(n):
    key=eval(input('Enter Emp name : '))
    value=eval(input('Enter salary'))
    d[key]=value
print(d)
...
s=input()   #  "Emp no = 25 , Emp name = Rama  Rao , sal = 10000.0 , gender = m"
p=s.split(',')
c=[]
d={}
for i in p:
...
d=eval(input()) # {10 : 'A' , 20 : 'B' , 15 : 'C' , 5 : 'D' , 12 : 'E'}
e=sorted(d.items)
d={}
for i in e:
    key,value=i[0],i[1]
    d[key]=value
print(d)    # {5 : 'D' , 10 : 'A' ,  12 : 'E' ,  15 : 'C' , 20 : 'B'}
