...
if  all(x in l2  for x in l1):
    print(True)
    print(f"yes , {l1} is sub set of {l2} ")
else:
   print(False) 
.................................................................
...
l1=eval(input("enter list complete :"))
max=0
mode=l1[0]
...
--> error , size  doest match 

#  Find  outputs  (Home  work)
a = [[]]
print(How  to  print  inner  list)  # a[0]
print(How  to  print  inner  list  in  another  way) # a[-1]
