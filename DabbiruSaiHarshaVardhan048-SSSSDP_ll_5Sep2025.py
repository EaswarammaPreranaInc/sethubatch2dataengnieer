...
a = (10 , 20 , 15 , 18)
print(a)#(10, 20, 15, 18)
f1(a)# error tupple is immutable
print(a)#(10, 20, 15, 18)
# Find  outputs (Home  work)
...
a  =  lambda  :  'Hyd'
print(a())#Hyd
print(a) #<function <lambda> at 0x000001E0F23E1F70>
# Find  outputs
...
Cyb
<class 'tuple'>
(<function <lambda> at 0x0000015A8E0777E0>, None, None)
<function <lambda> at 0x0000015A8E0777E0>
None
None
'''
#  Find  outputs  (Home  work)
s = 'Hyd'
print(lambda  s  :  print(s))# <function <lambda> at 0x000002689ABD77E0>
print(lambda  x  :  print(x) (s))# <function <lambda> at 0x000002689ABD77E0>
...
def   f2():
	print('Sec')
a = [f1 , f2]# [<function f1 at 0x000002689ABD77E0>, <function f2 at 0x000002679ABD77E0>]
for  x  in  a:
	     x()# Hyd     Sec
...
key = 'power_3'
print(a[key])# <function <lambda> at 0x000001F019D57740>
print(a[key](5))#125
# Find  outputs  (Home  work)
def   f1(x):
        return  lambda  n  :  x ** n
...
print(lamb(2))#9
print(lamb(5))#243
print(lamb)#<function f1.<locals>.<lambda> at 0x0000028FCDA97740>
print(lamb())#error
# Find  outputs   (Home  work)
def   eval(a , b , c):
