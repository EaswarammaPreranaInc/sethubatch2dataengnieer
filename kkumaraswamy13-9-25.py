...
Four
End
Type and address of generator function 'g'
One
25
...
<class 'dict'>
Type and address of a generator object
<class 'generator'>
...
print(next(g))
print(next(g))
print(next(g)) # Error due to StopIteration
...
def fib(n):
    ...
    while c<n:
        ...
        a,b=b,c
        c=a+b
m=int(input("Enter the last value of fibonacci series: "))
for num in fib(m):
    print(num)
print("End")
