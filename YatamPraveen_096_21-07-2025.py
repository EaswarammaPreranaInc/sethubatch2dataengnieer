...
#for item in a.items():
    print(item)
How  to  print  each  tuple  of  the  list  in  dict_items  object      #didn't understand the question
...
print(10 == 10.0)           # True
print(3 + 4j >  3 + 4j)      3Returns error as complex numbers can't be compared with > , <  , >=  and  <=
