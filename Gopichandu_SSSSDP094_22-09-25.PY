...
# Save in any file of cwd
from p1.mod1 import *
import p1   # to access _init_.py contents
...
# --- From _init_.py ---
# How to print object 'x' of _init_.py in package p1
print(p1.x)

# How to call function f1() of _init_.py in package p1
p1.f1()

# How to call method m1() of class c1 in _init_.py in package p1
obj = p1.c1()
obj.m1()
...
# print object 'x' from _init_.py
print(x)

# call function f1() from _init_.py
f1()

# call method m1() from class c1 in _init_.py
c1().m1()
...
# This loads _init_.py automatically
import p1
