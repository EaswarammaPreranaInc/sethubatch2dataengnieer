...
def   f2 (fun):
    print('f2  function')
    fun() #Error: there is no none type function
    print('Back  to  f2  function')
# end of the function
print('Begin')
f2(f1())
...
fun()
print('Bye')
inner() #error:inner function is not visible outside
'''
Outer Function
Hello
Inner Function
...
print(inner(10 , 3)) #error:inner function can't be called direcly because it isn't visible
