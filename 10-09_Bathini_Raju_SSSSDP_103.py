...
def toh(n, p1, p2, p3):
    if n == 1:   
        print(f"Move disk 1 from pole {p1}------> {p3}")
    else:
        
        toh(n-1, p1, p3, p2)
        print(f"Move disk {n} from pole {p1}------> {p3}")
        toh(n-1, p2, p1, p3)
n = int(input("How many disks ? : ")) # 3
toh(n, 1, 2, 3) 

# output
'''
How many disks ? : 3
Move disk 1 from pole 1------> 3
Move disk 2 from pole 1------> 2
Move disk 1 from pole 3------> 2
Move disk 3 from pole 1------> 3
Move disk 1 from pole 2------> 1
Move disk 2 from pole 2------> 3
Move disk 1 from pole 1------> 3
'''
