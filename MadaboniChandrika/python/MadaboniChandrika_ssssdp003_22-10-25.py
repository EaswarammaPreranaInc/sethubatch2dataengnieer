...
#print(c . add(10 , 20))#error,1 arg missing
...
print(c . add(10 , 20))#child method /n 33
...
class  c5(c1):
	def  _init_(slef):
		print('c1  class  constructor')
# End  of  the  class
#c1() #c1 is abstract class so it cannot be instantiated
c2() #c2 class constructor (no abs method)
c3() #c3 class constructor(not inherting abc class)
c4() #c4 class constructor
#c5() #c4 cannot be instantiated as it does not have m1 implementation
...
class  triangle(shape):
    def   get(self):
        ...
        self.c=float(input("Enter c value : "))#How  to  read  the  3  sides  of  triangle
    def   area(self):
...
class   rectangle(shape):
    def  get(self):
            ...
            super().get()
            self.b=float(input("Enter b value : "))#How  to  read  length  and  breadt
    def   area(self):
...
class   square(shape):
    def   get(self):
        print('Enter  any  side  of  square ' )
...
while  True:
    ...
    match   ch:
        case  1:
            t=triangle()
            operations(t)#How  to  call  operation()  function
        case  2:
            c=circle()
            operations(c)#How  to  call  operation()  function
        case  3:
            r=rectangle()
            operations(r)#How  to  call  operation()  function
        case  4:
            sq=square()
            operations(sq)#How  to  call  operation()  function
        case  5:
            exit()#How  to  stop  execution
	# End  of  match
# End of while  loop
...
#parent()#cannot be instantiated as it is a abstract class
#child()#cannot be instantiated as it does not have m2,m3 implementations
#gc()#cannot be instantiated as it does not have m3 implementation