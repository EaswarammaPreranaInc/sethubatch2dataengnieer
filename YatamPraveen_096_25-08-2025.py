...
ip = set(input('Enter the string : '))
print('String without duplicates : ', ''.join(ip))
...
ip, emp_list = set(eval(input('Enter the string : '))), []
emp_list.extend(ip)
print('List without duplicates : ', emp_list)
...
ip1 = set(eval(input('Enter the 1st list : ')))
ip2 = set(eval(input('Enter the 2nd list : ')))
print("Common  elements  between  the  2  lists :", list(ip1.intersection(ip2)))
...
print(id(a))          #Address at which dictionary object is stored
...
print(id(a))          #Same address as the dictionary itself is modified
...
a = {10 : 20 , 30 : 40}
b = {30 : 50 , 10 : 60}
print(a + b)              #This throws error as dictionaries can't be concatenated with +
c = {**a , **b}
print(c)                  #{10 : 60, 30 : 50}
d = a | b
print(d)                  #{10 : 60, 30 : 50}
...
ip, emp_dict = int(input('How many employees ? ')), {}
for i in range(ip):
  x = input('Enter Emp Name : ')
  emp_dict[x] = float(input('Enter Salary : '))
print(emp_dict)  
...
ip, emp_dict= input('Enter input : ').split(','), {}
for i in ip:
  i = i.split('=')
  x, y = i[0].strip(), i[1].strip()
  emp_dict[x] = int(y) if y.isdigit() else float(y) if y.replace('.', '').isdigit() else y
print(emp_dict)
...
print(sum(a))                     #90
print(sum(a . items()))           #This throws error as this turns out to be 0+(10:20)
...
print(dict(e))            #This throws error as inner sequence consists of 3 elements but not 2
f = [[10] , [20] , [30]]
print(dict(f))            #This throws error as inner sequence has 1 element but not 2
print(dict([10 , 20]))    #This throws error as it must be [(10, 20)] 
g = [[10 , [20 , 30]] , [40 , [50 , 60]] , [70 , [80 , 90]]]
print(dict(g))            #{10 : [20, 30], 40 : [50, 60], 70 : [80, 90]}
h = [[[10 , 20] , 30] , [[40 , 50] , 60] , [[70 , 80] , 90]]
print(dict(h))            #This throws error as dictionary key can't be mutable
...
sorted_keys = sorted(ip)
res_dict = {i:ip[i] for i in sorted_keys}
print(res_dict) 
...
print(a)              #{}
del  a
print(a)              #This throws error as a has been deleted
...
for  x , y   in  a . items():
       print(x, y, sep = ' ... ')     #10 ... Hyd <next line> 20 ... Sec <next line> 15 ... Cyb <next line> 18 ... Pune
for  x , y   in  a . keys():
       print(x, y, sep = ' ... ')     #This throws error as a.keys() gives 4 keys of a. So unpacking into 2 variables isn't possible         
for  x , y   in  a . values():
       print(x, y, sep = ' ... ')     #This throws error as a.values() gives 4 values of a. So unpacking into 2 variables isn't possible         
for  x , y   in  a:
       print(x, y, sep = ' ... ')     #This throws error as this is same as x, y in a.keys()
