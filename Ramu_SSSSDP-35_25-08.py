...
---------------------------------------
1) What  does  a . symmetric_difference(b)  do ? --->  Returns  a  set  with  all  the  elements  of  sets   'a'  and  'b' without  common  elements  i.e.  Union  -  Intersection
...
for i in range(n):
    ...
    dict[emp_name]=eval(input("Enter Salary :"))
print(dict)
...
print(dict(h)) # Error  keys  must be Immutable
