...
a . add(10 , 20 , 30) #{10 , 20 , 30,  25, 10.8 ,'Hyd', True}
a . add([10,20,30])   # {[10,20,30] , 10 , 20 , 30,  25, 10.8 ,'Hyd', True}
...
print(a . pop()) # {25 , 10.8 , 'Hyd' }
print(a . pop()) # {25 , 10.8 } -- hyd
print(a . pop()) # {25} -- 25
print(a . pop()) # {}  -- 10.8
print(a . pop()) # {} --error , nothing is threr for removing 
print(a) # {} 
b = {10 , 20 , 30 , 40}
