...
for i in range(2 , n + 1):
	if prime(i):
		print(i)
		ctr += 1
print(f'Number  of  prime numbers  : {ctr}')
...
a = [10 , 20 , 15 , 5 , 12]
print(sorted(reverse = True , a)) # Error as KA is followed by PA
print(sorted(a , rev = True)) # [5 , 10 , 12 ,15 , 20]
print(25 , 10.8 , 'Hyd' , separator = '\t') # 25 <tab> 10.8 <tab> 'Hyd'
...
f1(1 , b = 2 , c = 3 , d = 4 , e = 5 ,after *  there should be Keyword Arguments
...
# Identify  error  (Home  work)
def  f4(* , a , b , c , /): # Error as there is no clarity what should be done 
	        pass
...
print(add(80 , 90)) # only Keyword arguments should be sent to the function

# Find  outputs(Home  work)
def   add(a = 10 , b , c):
        pass
def   add( * , a = 10 , b , c ): # Error as default argument is followed by non default argument
        return  a + b + c
# End  of  the  function
