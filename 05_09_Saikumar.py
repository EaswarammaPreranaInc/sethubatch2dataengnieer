...
print(lambda x, y: x + y('Hyder', 'abad'))   # Error ('Hyder', 'abad') should be defined outside the function
...
a()                     # Error tuple are not callable
...
for x in a:
    x()                  #  Hyd <nextline> Sec
# a = [def f1(): print('Hyd'), def f2(): print('Sec')] # we cannot use def inside a list.
# print(a)
...
print(lamb())            # Error 1 argument should be send
