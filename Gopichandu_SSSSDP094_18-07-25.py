...
print(a * -1) # []
print(a * 4.0) #error
a = a * 3  #new object created
print(a) #[25 , 10.8 , 'Hyd',25 , 10.8 , 'Hyd',25 , 10.8 , 'Hyd']
print(id(a)) #1001
a = [25]
print(a * a) # cant multiply list to list

# list()  function  demo  program
a = list('Hyd')
print(a) #['Hyd']
print(type(a)) #<clss list>
print(len(a)) # 1
b = (10 , 20 , 15 , 18)
...
#     0     1     2    3     4
a = [10 , 20 , 30 , 40 , 50]
print(a , id(a)) # [10 , 20 , 30 , 40 , 50] adress of a 1000
a[1 : 4] = [60 , 70]
print(a , id(a)) #[10,60,70,50] address of a
a[2: 4] = [100 , 200 ,  300]
print(a , id(a)) # [10,60,100,200,300] new address of a 
...
a = tuple('Hyd')  # string is a sequnece
print(a) #('H',"y','d')
...
print(set(25)) #error
print(set([25 , 10.8 , [] , 'Hyd'])) # error [] mutable
...
a . append(100) # error 
a . add(set()) # set inside set is get error set is mutable
a . add(()) 
a . add([]) # eror
