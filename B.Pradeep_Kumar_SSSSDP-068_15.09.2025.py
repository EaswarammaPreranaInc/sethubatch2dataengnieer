...
g = f1()
print('Begin')  #  Begin
print(*g)  #   1,2,3,4,5..........100000000000000000000
print('End')  #  End
...
def  f1():
        ...
        yield  30
        yield  40
a , b , c = f1()  #  Error due to f1 have 4 values
p , q , r , s , m = f1()  #  Error due to f1 have 4 elements
...
# End  of  generator
g =  f1()
print(len(g))  #  Error due to generator not have len function
print(g * 3)  #  Error due to generator not multiply
print(g[0])  # Error
print(g[1 : 3])  #  Error
print(*g)  #  1 2 3
