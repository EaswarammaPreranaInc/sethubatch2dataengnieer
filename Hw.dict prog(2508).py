...
print(a) #a = {0, 1, 4, 9, 16, 25, 36, 49, 64, 81} in any order
...
print(out)
fout=" ".join(out)
print("string without duplicates: ", fout)
...
a = set(eval(input("enter 1: "))) 
b = set(eval(input("enter 2: "))) 
...
print(a('Ename'))
#How  to  print  'Rama Rao'  in  dict  'a')
print(a('Sal')) #How  to  print  value  1000.65   in  dict  'a')


9
# How  to  modify  values  of  dictionary  (Home  work)
a  =  {'Empno'  :  25,  'Ename'  :  'Rama  Rao'  ,  'Sal'  :  1000.65  },{'Empno'  :  25,  'Ename'  :  'Rama  Rao'  ,  'Sal'  :  1000.65  },'Ename'  :  'Rama  Rao'  ,  'Sal'  :  1000.65  }

print(a) #{'Empno'  :  25,  'Ename'  :  'Rama  Rao'  ,  'Sal'  :  1000.65  }{'Empno'  :  25,  'Ename'  :  'Rama  Rao'  ,  'Sal'  :  1000.65  }'Ename'  :  'Rama  Rao'  ,  'Sal'  :  1000.65  }

print(a) #{'Empno'  :  25,  'Ename'  :  'Rama  Rao'  ,  'Sal'  :  1000.65  }
print(id(a)) # address of a maybe 1000
a(Sal=2000)#How  to  modify  1000.65  to  2000
a('Rama Rao')='Sita'#How  to  modify  'Rama  Rao'  to  'Sita'
a('Empno')=35
...
b = eval(a) #converts str dict to dict
...
print(a  is  b) #False
print(a  ==  b) #True
c = a# ref c points to same dict which points by a
print(a  is   c) #True
print(a  ==  c) #True
...
d = {*a , *b , *c}
print(d) #d = {10, 20, 15, 18, 14, 25, 19}
...
a . clear() #del all key value pairs
print(a)#{}
del  a #del empty dictionary
print(a)#Error
