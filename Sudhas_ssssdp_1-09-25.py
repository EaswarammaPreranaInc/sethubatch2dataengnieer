...
def  f1(a = []):
        pass
print(f1.__defaults__)    # ([],) => tuple containing an empty list
...
print('_defaults : ', f1.__defaults__)           # ([0, 1, 4, 9, 16],)
print(f1(a = [100, 200, 300], x = 6))           # [100, 200, 300, 0, 1, 4, 9, 16, 25, 36]
print('_defaults : ', f1.__defaults__)           # ([0, 1, 4, 9, 16],)
print(f1(6))                                    # [0, 1, 4, 9, 16, 25, 36]
print('_defaults : ', f1.__defaults__)           # ([0, 1, 4, 9, 16, 25, 36],)
