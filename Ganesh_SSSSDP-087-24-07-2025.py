...
#  Find  output  (Home  work)
 print(eval('print("Hyd")'))                            #  Hyd by default moves NextLine  eval ('print()') returns None
...
# What  is  the  advantage  of  eval(input()) ?
 x = eval(input('Enter  any  input  :  ')) input:                  #  "Hyd"
  print(type(x))                                                   # <class str>
  print(x)                                                         # Enter any Input: Hyd

# What  is  a  better  approach  to  read  string  input ?
 a = input('Enter  any  string  :  ') -->input:                    # Hyd
  print(len(a))                                                    # 3
  print(a)                                                         # Enter any string Hyd
  b = eval(input('Enter   any  string  : '))                       # "25"
  print(len(b))                                                    # 2
  print(b)                                                         #Enter any string:  25
 ...
 a , b , c = 25 , 10.8 , 'Hyd'
  ...
  print(a , b , c , separator = ':')                               # errror

 # Find  outputs  (Home  work)
  a , b , c = 25 , 10.8 , 'Hyd'
  print(a , b , c , end = '---')                     # 25 10.8  Hyd---
  print(a , b , c , sep = ',,,')                     -->same line #  25,,,10.8,,,hyd
  print(a , b , c , sep = ':::' , end = '\t\t\t')    ---> nextline  #  25:::10.8:::Hyd    
  print(a , b , c)                                   ---> sameline # 25 10.8 Hyd

 # Find outputs  (Home  work)
  print('Hyd')                                      # Hyd  <nextline>
  print()                                           # <space>
  print('Sec')                                      # Sec  <nextline>
  print()                                           # <space>
  print('Cyb')                                      # Cyb
...
# Find  outputs  (Home  work)
 ...
 #Find outputs  (Home  work)
  ...
  b = 10.9274
  c = 'Hyd'
  print('%d    %f    %s'  %(a , b , c))                     #  25.000000  10.927400  Hyd
