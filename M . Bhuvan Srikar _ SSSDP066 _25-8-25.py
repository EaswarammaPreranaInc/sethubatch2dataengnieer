...
b = {30 , 40 , 50 , 60}
c = a . difference(b)
print(c) # {10 , 20} can be any order
print(type(c)) # <class 'set'>
d = a - b
print(d) # {10 , 20\} can be any order
print(type(d)) # <class 'set'>
print(c  is  d) # False
print(c  ==  d) # True
...
print(c) # {10 , 20 , 50 , 60} can be any order
print(type(c)) # <class 'set'>
d = a ^ b
print(d) # {10 , 20 , 50 , 60} can be any order
print(type(d)) # <class 'set'>
print(c   is   d) # False
print(c  ==   d) # True
...
print(a) # {0 , 1 , 4 , 9 , 16 , 25 , 36 , 49 , 64 , 81} can be in any order
...
d = set(b)
e = c . intersection(d)
print(f'Common Elements Between the 2 Lists : {list(e)}')
...
a = {10 : 20 , 30 : 40}
b = {30 : 50 , 10 : 60}
print(a + b) # error as dict cannot be concatenated with + operator
c = {**a , **b} 
print(c) # {10 : 60 , 30 : 50}
d = a | b
print(d) # {10 : 60 , 30 : 50} 
...
'''
a = int(input('How many Empployes : '))
b = {}
for x in range(a):
...
print(dict(e)) # error as there are more elements for key value pairs
f = [[10] , [20] , [30]]
print(dict(f)) # error as there are less elements for key value pairs
print(dict([10 , 20])) # Error as cannot convert to sequence
g = [[10 , [20 , 30]] , [40 , [50 , 60]] , [70 , [80 , 90]]]
print(dict(g)) # {10 : [20 , 30] , 40 : [50 , 60] , 70 : [80 : 90]}
h = [[[10 , 20] , 30] , [[40 , 50] , 60] , [[70 , 80] , 90]]
print(dict(h)) # error as keys cannot hold mutable elements
...
print(a) # error as dictionary is deleted
...
a = {10 : 'Hyd' , 20 : 'Sec' , 15 : 'Cyb' , 18 : 'Pune'}
b = a . values()
print(b) # dict_keys(['Hyd' , 'Sec' , 'Cyb' , 'Pune'])
...
for  x , y   in  a . items():
       print(x , y , sep = ' ... ') #  10 ... Hyd <next line> 20 ... Sec <next line> 15 ... Cyb <next line> 18 ... Pune
for  x , y   in  a . keys(): # error as there are to many values to unpack
       print(x , y , sep = ' ... ')
for  x , y   in  a . values():  # error as there are to many values to unpack
       print(x , y , sep = ' ... ')
for  x , y   in  a:  # error as there are to many values to unpack
       print(x , y , sep = ' ... ')
