...
class   c2:
        pass
class   c3:#error there is no stmt inside class
...
print(a . __dict__)# error due to instance variable
print(a)#nothing
del  a
print(a)#nothing
...
# End  of  class  c1
a = c1()
a . m1(10 , 20)#two argument method :,x,y
a . m1(30)#error
a . m1()#it requires atleast one argument
...
a = c1()
a . m1(10 , 20)# two argument method :,x,y
a . m1(30)#two argument method :,x = 30 , y =2
a . m1()# two argument method :,x=1,y=2
...
class triangle:
    ...
    def test(self):
        # Check if sum of every 2 sides >= 3rd side
