...
a = [[10 , 20 , 15 , 18]]
print(sum(a)) # 63
print(How  to  determine  sum  of  inner  list  elements)# a[0]
print(How  to  determine  sum  of  inner  list  elements  in  another  way)# *a
...
c = sorted(a , reverse = True)
print(c) # ['Vamshi', 'Sita', 'Rama Rao', 'Rama', 'Rajesh', 'Kiran', 'Amar']
...
a = [25 , 10.8 ,  'Hyd' ,  True]
a . sort()
Error : '<' is not supported between string and float 
...
list = [10 , 20 , 18 , 19 , 17 , 20 , 14]
a = 15
result = [i for i in list if i !=a]
print('enter list:',list )
print('element to be deleted:', a)
print("List without", a, "s :",result)
output: enter list: [10, 20, 18, 19, 17, 20, 14]
element to be deleted: 15
List without 15 s : [10, 20, 18, 19, 17, 20, 14]
...
if first_count == n:
    ...
    print("elements are not identical")    
 output:elements are not identical
