...
def    f1(a , b , c):
	return  a + b * c
#end  of  the  function
print(f1(3 , 4 , 5))  # 3+20=23
print(f1(*[6 , 7 , 8])) # 6+56 =62
...
f1(190 , b = 200 , c = 210) # error
 ...
 # Find outputs(Home  work)
def  f1(a , b , / , c , d , * , e  , f):
        print(F'a  :  {a}  \t  b  :  {b}  \t  c  :  {c}  \t  d  :  {d}  \t  e  :  {e}  \t  f  :  {f}')  # a:10 b:20 c:30 d:40 e:50 f:60 

# End of the function
f1(10 , 20 , 30 , d = 40 , e = 50 , f = 60) # error 
...
def   add(a  , b = 20 , c = 30):
        return   a + b + c  
#end  of  the  function  # 30
print(add(100)) # 100+20+30 
