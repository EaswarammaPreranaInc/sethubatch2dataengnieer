...
f1(10 , 20 , x = 30)                            # error due to x is not defined
f1(10 , 20)                                     # error due to positional arguments
...
print(f1(3 , 4 , 5))                         # 23
print(f1(*[6 , 7 , 8]))                      # 62
print(f1([6 , 7 , 8]))                       # error because only one list argument
print(f1(*{1 : 2 , 3 : 4 , 5 : 6}))          # 16
print(f1({'c' : 2 , 'b' :  4 , 'a' : 6}))    # error because only one dict argument
print(f1({'c' : 2 , 'b' :  4 , 'a' : 6}))    # error because only one dict argument
...
a = [10 , 20 , 15 , 5 , 12]
print(sorted(reverse = True , a))                       # error due to positonal argument follows keyword argument
print(sorted(a , rev = True))                           # error due to positional argument follows keyword argument
print(25 , 10.8 , 'Hyd' , separator = '\t')             # error due to positional argument follows keyword argument
print(25 , 10.8 , 'Hyd' , endofline = '\t')             # error due to positional argument follows keyword argument
print(25 ,  sep = '\t' , 10.8 , end = '\t' , 'Hyd')     # error due to positional argument follows keyword argument
...
# Identify error (Home  work)
def   f1(a  , b , *):
        pass                            # error * is used before keyword
...
print(add())                                # error there is no positional argument
