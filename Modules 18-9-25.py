...
print(dir(sys)) # list of strings of all the environment variables and members of the sys module
print()
print()
print(dir(time)) # list of strings of all the environment variables and members of the time module
print() 
print(dir(math)  # list of strings of all the environment variables and members of the math module


#  Find  outputs  (Home  work)
import  cal
print(dir(cal)) # list of stings of all the environment variables and add , div , mul , sub , x , y
...
class  c1:
        def  m1(self):
                pass
print(dir()) # all Environment variables with c1 , disp and x of current module
print(type(dir())) # <class 'list'>
print(type(dir)) # <class 'bulitinsormethod'>
...
import  cal
print()
print(dir()) # list of stings of all the environment variables and cal module
...
from  cal  import  *
print()
print(dir())  # list of stings of all the environment variables and add , div , mul , sub , x , y
...
print(randint(1 , 100)) # random integer number between 1 and 100
print(uniform(1 , 100)) # random float number between 1 and 100
print(randrange(10)) # random integer number between 0 to 9 excluding 10
print(randrange(1 , 11)) # random integer number between 1 to 10 excluding 11
print(randrange(1 , 11 , 2)) # random integer number between 1 to 10 in steps of 2
list = [10 , 20 , 15 , 12 , 18]
print(choice(list)) # any random element of the list
print(choice('RAJESH')) # any random element of the string
set  =  {10 , 20 , 30 , 40} 
...
b = '0123456789'
for x in range(10):
	print(choice(a),choice(b),choice(a),choice(b),choice(a),choice(b) , sep = '')
...
try:
	...
	print('Enter values 0 , 1 and 2 only')
except ValueError:
	print('Enter values 0 , 1 and 2 only')
