...
def rev_num(n):
    if n==0:
        ...
        return n%10*(10**(len(str(n))-1))+rev_num(n//10)
    
n=int(input("enter number : "))
print(f"reverse of number  {n} is: {rev_num(n)}")
.................................................
...
11. # Find  output(Home  work)
def    f1(a):
	def   f2():
		return  10
	# End  of  f2  function
	return  f2() + 20 +  a    # 30+20+10=60
# End  of  f1  function
print(f1(30)) # 60 
