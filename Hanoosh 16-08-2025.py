...
a = [1,2,3]
b = [4,5,6]
print(a , id(a)) # [1,2,3] address ex:- 1000
a += b
print(a , id(a)) # [1,2,3,4,5,6] address ex:- 1000
...
a = [1,2,3]
b = [4,5,6]
print(a , id(a)) # [1,2,3] address ex:- 2000
a  = a + b
print(a , id(a)) # [1,2,3,4,5,6] address ex:- 2000
...
list = [25 , 10.8 , 'Hyd' , True , 3 + 4j]
a , *b , c , *d , e  = list # multiple * assigned
