...
def   f1(x , a = []):
	...
	print('List :  ' ,  a)
#end  of  the  function
print('defaults  :  ' , f1.__defaults__)#([],)
f1(3)#[3]
print('defaults  :  ' , f1.__defaults__)#([3],)
f1(4 , [1 , 2 , 3])#[1, 2, 3, 4]	
print('defaults  :  ' , f1.__defaults__)#([3],)
f1(9)#[3, 9]
print('defaults  :  ' , f1.__defaults__)#([3, 9],)
f1(40 , [10 , 20 , 30])#[10, 20, 30, 40]
print('defaults  :  ' , f1.__defaults__)#([3, 9],)
f1(5)#[3, 9, 5]
print('defaults  :  ' , f1.__defaults__)#([3, 9, 5],)
f1([6 , 7 , 8])#[3, 9, 5, [6, 7, 8]]
print('defaults  :  ' , f1.__defaults__)#([3, 9, 5, [6, 7, 8]],)
...
print('defaults  :  ' , f1.__defaults__)#([],)
print(f1(3))#[0, 1, 4]
print('defaults  :  ' , f1.__defaults__)#([0, 1, 4],)
print(f1(4 , [10 , 20 , 15 , 18]))#[10, 20, 15, 18, 0, 1, 4, 9]
print('defaults  :  ' , f1.__defaults__)#([0, 1, 4],)
print(f1(5))#[0, 1, 4, 0, 1, 4, 9, 16]
print('defaults  :  ' , f1.__defaults__)#([0, 1, 4, 0, 1, 4, 9, 16],)
print(f1(a = [100 , 200 , 300],   x = 6 ))#[100, 200, 300, 0, 1, 4, 9, 16, 25]
print('defaults  :  ' , f1.__defaults__)#([0, 1, 4, 9, 16],)
print(f1(6))# [0, 1, 4, 0, 1, 4, 9, 16, 0, 1, 4, 9, 16, 25]
print('defaults  :  ' , f1.__defaults__)#( [0, 1, 4, 0, 1, 4, 9, 16, 0, 1, 4, 9, 16, 25],)
