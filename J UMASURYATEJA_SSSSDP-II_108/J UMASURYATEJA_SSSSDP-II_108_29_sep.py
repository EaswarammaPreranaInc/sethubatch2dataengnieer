...
<main.c2 object at 0x7ad41a631cd0>
c2 class constructor
None
...
#end of the  class
a = f1()#Constructor
print(a)#<main.f1 object at 0x7b8e96c35c40>
...
class  c1:
	def init(self):
		...
		self.x = 30#How  to  initialize  public  dunder  variable  'x'  with  30
	def  m1(self):
		print('public method')
	def  __m1(self):
...
print(a.x)#How  to  print  public  dunder  variable  'x'
print(a.c1_x)#How  to  print   private  variable  'x'
#print(a . __x) --> Error
a.m1()#How  to  call  public  method  m1()
a.m1()#How  to  call  public  dunder  method  m1()
...
class   c1:
	def  del(self , x):#only takes self no other arg
		print('destructor : ' ,  x)
a = c1()
a . del(25)# automatically called destructor
