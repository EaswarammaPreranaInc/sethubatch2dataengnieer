...
a=int(input('How  many  lists  ?  : '))
b=int(input('How  many  elements  in  each  list ?  : '))
c=[[i*0 for i in range(b)] for j in range(a)]
c
...
'''
list1=[i**2 for i in range(1,21) if i**2%2==0]
print('Squares  of  1  to  20  which  are  divisible  by   2 :',list1)
...
#  Repeat  previous  program  with  comprehension  and  without  using  if
list1=[i**2 for i in range(2,21,2)]
print('Squares  of  1  to  20  which  are  divisible  by   2 :',list1)
...
print(b)    #[[10, 20], [10, 20], [30, 40, 50], [30, 40, 50], [30, 40, 50], [60, 70, 80, 90], [60, 70, 80, 90], [60, 70, 80, 90], [60, 70, 80, 90]]#  Nested  comprehension  demo  program (Home  work)
