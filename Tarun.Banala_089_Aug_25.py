...
print(*a) # 10 20 15
print(**a) # error
print({**a}) # {10 : 'Rama' , 20 : 'Sita' , 15 : 'Rajesh'}
...
'''
a={}
n=int(input("enter a no. of emps:"))
for i in range(n):
...
'''
n={10 : 'A' , 20 : 'B' , 15 : 'C' , 5 : 'D' , 12 : 'E'}
print(dict(sorted(n.items())))
...
for  x , y   in  b:
        print(x , y , sep = ' ... ')
# 10 ... Hyd  nl 20 ... Sec nl 15 ... Cyb nl  18 ... Pune
