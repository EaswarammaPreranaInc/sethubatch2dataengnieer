...
print('__defaults__  :  ' , f1.__defaults__) # __defaults__  : ([],)
print(f1(3)) # [0,1,4]
print('__defaults__  :  ' , f1.__defaults__) # _defaults__  :   ([0,1,4],)
print(f1(4 , [10 , 20 , 15 , 18])) # [10 , 20 , 15 , 18,0,1,4,9]
print('__defaults__  :  ' , f1.__defaults__) # _defaults__  :   ([0,1,4],)
print(f1(5)) # [10 , 20 , 15 , 18,0,1,4,9,16]
print('__defaults__  :  ' , f1.__defaults__) # _defaults__  :   ([10 , 20 , 15 , 18,0,1,4,9,16],)
print(f1(a = [100 , 200 , 300],   x = 6 )) # [100 , 200 , 300,0,1,4,16,25]
print('__defaults__  :  ' , f1.__defaults__) # _defaults__  :   ([10 , 20 , 15 , 18,0,1,4,9,16],)
print(f1(6)) # [10 , 20 , 15 , 18,0,1,4,9,16,0,1,4,9,16,25]
print('__defaults__  :  ' , f1.__defaults__) # _defaults__  :   ([0, 1, 4, 0, 1, 4, 9, 16, 0, 1, 4, 9, 16, 25],)
