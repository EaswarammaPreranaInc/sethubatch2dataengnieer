...
try:
    ...
    while (i := a.index(15, i + 1)) >= 0:   # walrus operator used
        print(i)
except ValueError:
    print(f'15 is found {a.count(15)} times')
...
a = [10 , 20 , 15 , 18]
b = a . copy()
print(b) #new list same as a
print(a  is  b) #False
print(a  ==  b) #True
c = a[:]
print(c) # new list same as a
print(a  is  c) #False
print(a  ==  c) #True
d = a
print(d) #same list as a
print(a  is  d) #True
print(a  ==  d) #True
copy()  method
------------------
...
for x in a:   # directly iterating (no indexes)
    print(x)
print('Elements in the form of matrix without using indexes')
for x in a:   # outer list
    for y in x:   # inner list
        print(y, end=" ")
    print()
print('Elements in the form of matrix using indexes')
for i in range(len(a)):         # indexes of outer list
    for j in range(len(a[i])):  # indexes of inner list
        print(a[i][j], end=" ")
    print()
matrix   style
----------------
...
[60, 70, 80, 90]
10...20
Error: Remaining two has more elements
