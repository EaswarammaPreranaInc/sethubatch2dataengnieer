...
print(sum(d)) # 63
e = [25 , 10.8 , 'Hyd' , True]
print(sum(e)) # TypeError because of String object
...
#  Find  outputs
a = [[10 , 20 , 15 , 18]]
print(sum(a)) # TypeError  because  if list inside list
...
print(min(b)) #Amar
c = [25 , 10.8 ,  3 + 4j , True]
print(max(c)) # TypeError because of complex object
d = [25 , '35'] 
print(max(d)) #Type Error
print(max([])) #ValueError because of empty list
print(min([])) #ValueError because of empty list
