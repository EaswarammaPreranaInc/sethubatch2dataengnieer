...
print()
print()
# object 'x' of _init_ module in package p1
print(p1.x)
# function f1() of _init_ module in package p1
print(p1.f1())
# method m1() of class c1 in _init_ module of package p1
obj2 = p1.c1()
obj2.m1()
...
# Save in any file of cwd
import p1        # imports _init_.py of package p1
# object 'x' of _init_ module in package p1
print(p1.x)
# function f1() of _init_ module in package p1
print(p1.f1())
...
from p1 import mod1
from p1.mod1 import *
import p1._init_     # error, _init_ is not imported this way
