...
def  toh(n , p1 , p2 , p3):
	...
	toh(n-1, p2, p1, p3)#	How  to  move  disk  from  pole1  to  pole3
		#How  to  move  (n - 1)  disks  from   pole2  to  pole3  and  pole1  is  intermediate  (Use  recursion)
# toh( 3 , 1 , 2 , 3)
n = int(input('How many disks ? :   '))
print(f"\nSteps to move {n} disks from pole 1 to pole 3:")
toh(n, 1, 2, 3)
...
#  Identify  Error
def   f1():
        nonlocal   x#nonlocal method possible within the function
# Find  outputs (Home  work)
def  outer():
	a = 10
	b = 20
...
def   outer():
	...
	def  inner():
		...
		nonlocal  x
'''
Here we did not call any function, and also we could not have gloabal and nonlocal one after another
'''
