...
fun()
print('Bye')
#inner() # Error due we cannot access inner function
# Outer Function
# Hello
# Inner function
# Bye
...
print(div(10 , 3))
print(div(10 , 0))
#print(inner(10 , 3)) # Error due we cannot access inner function directly
# 3.33
...
def  decor(fun):
    def inner(a, b):
        return fun(a, b) # How  to  decorate  the  function  such  that  4.5  is  returned
    return inner
@decor
def  div(a , b):
    return   a / b
