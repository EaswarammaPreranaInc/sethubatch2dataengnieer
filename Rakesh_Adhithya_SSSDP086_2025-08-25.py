...
d = a & b     
print(d)                #{30, 40} in same order of a.intersection(b)
...
print(type(c))          #<class 'set'>
d = a - b               
print(d)                #{10, 20} in same order as a.difference(b)
print(type(d))          #<class 'set'>
print(c is d)           #False
print(c == d)           #True
...
print(type(c))                  #<class 'set'>
d = a ^ b
print(d)                        #{10, 20, 50, 60} in same order as above
print(type(d))                  #<class 'set'>
print(c is d)                   #False
print(c == d)                   #True
...
print(sum(a))                 #90
print(sum(a.items()))         #Error, int and tuple can't be added
...
# print(dict(e))                                                    #Error, inner sequences length should be strictly 2
# f = [[10], [20], [30]]
# print(dict(f))                                                    #Error, inner sequences length should be strictly 2
# print(dict([10, 20]))                                             #Error, only nested sequences are permitted
g = [[10, [20, 30]], [40, [50, 60]], [70, [80, 90]]]
print(dict(g))                                                      #{10: [20, 30], 40: [50, 60], 70: [80, 90]}
# h = [[[10, 20], 30], [[40, 50], 60], [[70, 80], 90]]              #Error, dict keys cann't have mutable elements
# print(dict(h))                                                      
...
'''
map = eval(input('Enter dictionary:  '))
...
print(a)     #{}
del a
#print(a)     #Error, name a is deleted
...
for x, y in a.items():
    print(x, y, sep=' ... ')    #10...Hyd <nl> 20...Sec <nl> 15...Cyb <nl> 18...Pune
# for x, y in a.keys():           #Error, keys contain only single elements
#     print(x, y, sep=' ... ')    
# for x, y in a.values():         #Error, values contain only single elements
#     print(x, y, sep=' ... ')
# for x, y in a:                  #Error, keys contain only single elements
#     print(x, y, sep=' ... ')
...
print(rno1, sname1)          #10 <sp> Rama
print(rno2, sname2)          #20 <sp> Sita
print(rno3, sname3)          #15 <sp> Rajesh
