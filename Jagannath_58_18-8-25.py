...
print(min(b))                                                                       Amar
c = [25 , 10.8 ,  3 + 4j , True]
print(max(c))                                                                       TypeError
d = [25 , '35']
print(max(d))                                                                       TypeError
...
print(list(b))                                                                [(10, 20), (30, 40, 50), (60, 70, 80, 90)]   # order may vary
c = ([10 , 20] , (30 , 40) , {50 , 60})
...
a = [25 , 10.8 ,  'Hyd' ,  True]
a . sort()                                        cannot compare string and float
