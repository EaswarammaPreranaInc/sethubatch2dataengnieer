...
a = [1,2,3]
b = [4,5,6]
print(a , id(a))  # [1,2,3] 1234567890
a += b
print(a , id(a))  # [1,2,3,4,5,6]  1234567890
...
a = [1,2,3]
b = [4,5,6]
print(a , id(a))  # [1,2,3] 123456
a  = a + b
print(a , id(a))  #[1,2,3,4,5,6] 123456787
...
list = [25 , 10.8 , 'Hyd' , True , 3 + 4j]
#a , *b , c , *d , e  = list # Error due to multiple starred expresion
