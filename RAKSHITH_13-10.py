...
class   circle:
    def   get(self):
        self.r=int(input('Enter radius of the circle : ')) #How  to  read  radius  into  object
    def   area(self):
...
class  cylinder(circle):
    def   get(self):
        self.r=int(input('Enter radius of the cylinder : ')) #How  to  read  radius  into  object  self
        self.h=int(input('Enter height of the cylinder : '))    # How  to  read  height  into  object  self
    def  area(self):
...
class   square:
    def   get(self):
        self.s=int(input('Enter side of a square : '))  #How  to  read  side  of  square
    def   area(self):
...
class   rectangle(square):
    def   get(self):
        self.l=int(input('Enter length of the rectangle : '))   #How  to  read  length  of  rectangle
        self.b=int(input('Enter breadth of the rectangle : '))   #How  to  read  breadth  of  rectangle
    def   area(self):
...
class   cube(square):
    def   get(self):
        self.s=int(input('Enter side of a cube :')) #How  to  read  side  of  cube
    def   area(self):
...
class  c5(c1):
    ...
    def  m2(self):
        c=c3()
        c.m1()   #How  to  call  m1()  method  of  class  c3
        c=c4()
        c.m1()   #How  to  call  m1()  method  of  class  c4
        c=c2()
        c.m1()   #How  to  call  m1()  method  of  class  c2
        super(c5,self).m1()   #How  to  call  m1()  method  of  class  c1
...
a = c1()
b = c2()
print(issubclass(b , a))    #TypeError: issubclass() arg 1 must be a class
print(issubclass(c2 , a))   #TypeError: issubclass() arg 2 must be a class
...
print(issubclass(c4 , [int , float , c1 , str , bool])) #TypeError: issubclass() arg 2 must be a class, a tuple of classes, or a union
...
print(isinstance(a , [int  ,  float  ,  c3 , str  ,  bool]))    #TypeError: isinstance() arg 2 must be a type, a tuple of types, or a union
