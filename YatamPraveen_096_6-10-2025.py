...
a = c1(10)
b = c1(20)
print(a >= b)               #__ge__ method : 10 20<next_line>False
print(a <= b)               #__ge__ method : 20 10<next_line>True
...
a = c1(10)
b = c1(20)
print(a != b)       #__eq__ method  : 10 20<next_line>True
print(a == b)       #__eq__ method  : 10 20<next_line>False
...
a = c1(25)
b = c1(25)
print(a == b)                   #__eq__ method : 25 25<next_line>None
print(a != b)                   #__eq__ method : 25 25<next_line>True
print(a.x != b.x)               #False
