...
print(a [ : 7])	#a[0:7:0]---->string  from  indexes  0  to  6  in  steps  of  1  	i.e.Rama Ra
...
print(a [-6 : ])	#a[-6:1:1]----->string  from  indexes  -6  to  0  in  steps  of  1  	i.e. ma Rao
print(a [: -4 : -1])	#a[-1:-4:-1]----->string  from  indexes  -1  to  -5  in  steps  of  -1  	i.e. oaR
...
print(a [ : ])	#a[0:8:1]------------>string  from  indexes 0  to  7  in  steps  of  1  	i.e.Rama Rao
print(a [ : : -1])	#a[-1:-9:-1]--------->string  from  indexes -1  to  -9  in  steps  of  -1  	i.e.oaR amaR
...
print(a [ : -5 : -5])	#a[0:-5:-5]--------->string  from  indexes 0  to  -5  in  steps  of  -5  	i.e.o
...
print(a [ : 0 : -1])	#[ 0: 0 : -1]--------->string  from  indexes 0 to  0 in  steps  of -1 	i.e.oaR ama
#print(a [-5 : 0 : -2])	#[-5 : 0 : -2]--------->string  from  indexes -5 to  0 in  steps  of -2 	i.e.aa 
