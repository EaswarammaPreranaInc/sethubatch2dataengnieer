...
print(a) # ['Rama' , 'Rajesh' , 'Amar' ,  'Sita' ,  'Vamsi' , 'Kiran' , 'Rama  Rao']
a . sort()
print(a) # ['Amar','Kiran','Rajesh','Rama','Rama Rao','Sits','Vamsi']
a . sort(reverse = True)
...
a = [25 , 10.8 ,  'Hyd' ,  True]
a . sort() # Error dont support str and float
...
'''
a = eval(input("Enter a list : ")) # [10 , 20 , 15 , 10 , 14 , 10 , 18 , 20 , 19]
b = []
for i in a:
	if a.count(i) == 1:
		b.append(i)
...
list = eval(input("Enter a list : ")) # [25 , 25 , 25 , 25]
