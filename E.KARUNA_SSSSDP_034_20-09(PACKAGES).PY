...
print(p1 . mod1 . x) # prints value of x
print(x) # error
...
from  p1 . mod1    import    *
from  p1 . mod2    import    *
print(x) # p1.mod2 of x member is printed
f1() # call p1.mod2 f1 fun
a = c1() # creating obj from mod2
a . m1() # method calling by obj
...
from  p1 . mod2    import   *
from  p1 . mod1    import   *
print(x) # p1.mod1 of x member is printed
f1() # call p1.mod1 f1 fun
a = c1() # creating obj from mod1
a . m1() # method calling by obj
