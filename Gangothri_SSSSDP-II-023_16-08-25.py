...
a = [1,2,3]
b = [4,5,6]
print(a , id(a))  #  [1,2,3] 777879
a += b
print(a, id(a)) # [1,2,3,4,5,6] 777879

# Tricky  program
#  Find  outputs
a = [1,2,3]
b = [4,5,6]
print(a , id(a)) # print the list of a and address of a object
a  = a + b
print(a, id(a)) # prints list a and b [1,2,3,4,5,6] address is different
