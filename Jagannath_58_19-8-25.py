...
a = [[10 , 20] , [30 , 40 ,  50] , [60 , 70 , 80 , 90]]
print('Nested list  with  print function')                                                                                                 print(a)
print(???)
...
print('Elements  in  the  form   of  matrix   without  using  indexes')                                                                    for inner in a:
                                                                                                                                                for element in inner:
                                                                                                                                                     print(element,end=' ')
                                                                                                                                                print()
How  to   print  elements  of  each  inner  list  without  using  indexes  in  matrix style  (use  nested  loop)
print('Elements  in  the  form   of  matrix  using  indexes')                                                                               for i in range(len(a)):             
