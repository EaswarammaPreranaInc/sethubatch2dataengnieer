...
from G_Narendra_SSSSDP041_28_Aug_25 import is_prime
...
print(25 ,  sep = '\t' , 10.8 , end = '\t' , 'Hyd')#Errir
...
f1(70 , 80 , c = 90)# TypeError: f1() takes 1 positional argument but 2 were given
...
def   f1(a  , b , *):
        pass
# SyntaxError: named arguments must follow * (asterisk)
...
f1(1 , 2 , 3 , 4 , 5 , f = 6)# TypeError: f1() got multiple values for argument 'f'
...
def  f1(/ , a , b ,  c):
        pass
# SyntaxError: '/' must precede positional-only arguments
...
# Only the last defined f1 survives
...
print(add(50 , 60 , 70))         # 4-argument  function, 50+60+70+4=184
print(add(80 , 90))              # 4-argument  function, 80+90+3+4=177
print(add(100))                  # 4-argument  function, 100+2+3+4=109
print(add())                     # 4-argument  function, 1+2+3+4=10
