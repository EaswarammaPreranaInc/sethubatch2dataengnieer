...
print(id(a)) #same address of object a
...
print(dict(e)) #Error: more than 2 values in list
f = [[10] , [20] , [30]]
print(dict(f)) #Error:less than 2 values in list
print(dict([10 , 20])) #Error: argu ment is not a nested sequence
g = [[10 , [20 , 30]] , [40 , [50 , 60]] , [70 , [80 , 90]]]
print(dict(g)) # {10: [20, 30], 40: [50, 60], 70: [80, 90]}
h = [[[10 , 20] , 30] , [[40 , 50] , 60] , [[70 , 80] , 90]]
print(dict(h)) #Error: nested list with more than 2 values
...
sorted_dict = {k: a[k] for k in sorted(a.keys())}
print(sorted_dict)
...
for  x , y   in  a . keys():
       print(x , y , sep = ' ... ') #Error:iterator has only one value
for  x , y   in  a . values():
       print(x , y , sep = ' ... ') #Error:iterator has only one value
for  x , y   in  a:
       print(x , y , sep = ' ... ') #Error:default iterator is keys() only it has only one value
