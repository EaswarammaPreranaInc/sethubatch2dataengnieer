...
a = [10 , 20 , 15 , 5 , 12]
print(sorted(reverse = True , a))                            position argument follows keyword argument
print(sorted(a , rev = True))                                position argument follows keyword argument
print(25 , 10.8 , 'Hyd' , separator = '\t')                  position argument follows keyword argument
print(25 , 10.8 , 'Hyd' , endofline = '\t')                  position argument follows keyword argument
print(25 ,  sep = '\t' , 10.8 , end = '\t' , 'Hyd')          position argument follows keyword argument
