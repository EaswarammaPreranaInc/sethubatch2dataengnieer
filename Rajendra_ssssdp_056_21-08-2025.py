...
#a[3] = 'Sec'	#tuple don't allow Object Assignment
#a[3 : 6] = 60 , 70 , 80	#tuple don't allow Object Assignment
'''
...
a += b 
print(a , id(a))	# (1, 2, 3, 4, 5, 6) 10022
...
a[1] = [80 , 90 , 100]	# Error tuple don't allow item assignment
print(a)		# pvm don't go to this statement
