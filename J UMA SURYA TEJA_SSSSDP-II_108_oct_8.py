...
print(b . _dict_)#{'y': 21}
print(c1 . _dict)# {'module': 'main', 'x': 10, 'init': <function c1.init_ at 0x...>, '_dict': <attribute 'dict' of 'c1' objects>, 'weakref': <attribute 'weakref' of 'c1' objects>, 'doc_': None}
...
#End  of  the  class
print('Begin')
print(c1 . _dict)#shows {'module_', 'a': 10, ...}
print()
print()
x = c1()
print('Constructor')
print(c1 . _dict)#shows {'module', 'a':10, 'b':20, 'k':25, 'init_', ...}
print()
print()
How  to  call  m1()  method#x.m1()
print('Instance  method  m1')
print(c1 ._dict)#shows {'module_', 'a':10, 'b':20, 'k':25, 'd':40, ...}
print()
print()
How  to  call  m2()  method#c1.m2()
print('class  method   m2')
print(c1 . _dict)# shows {'module_', 'a':10, 'b':20, 'k':25, 'd':40, 'f':60, 'g':70, ...}
print()
print()
How  to  call  m3()  method#c1.m3()
print('static   method   m3')
print(c1 . _dict)# shows {'module_', 'a':10, 'b':20, 'k':25, 'd':40, 'f':60, 'g':70, 'h':80, ...}
print()
print()
...
#Sample output:
{'module': 'main', 'firstlineno': 6, 'x': 1, 'y': 2, 'z': 3, 'static_attributes': (), 'dict': <attribute 'dict' of 'c1' objects>, 'weakref': <attribute 'weakref' of 'c1' objects>, 'doc': None}
