...
#self . m1()	
						#Error #self cannot be used outside the class
'''
	outputs:
 parent method
 parent method
...
class   child(parent):
	...
	def   m2():
		...
		super() . m1() 						# Error  cannot be used for static methods
...
child.m2() 								# How  to  call  m2()  method  of  child  class
child . m1() 	
							# Executes the method of parent class as there is no m1 method in child class
'''
	outputs:
 parent method
 parent method
