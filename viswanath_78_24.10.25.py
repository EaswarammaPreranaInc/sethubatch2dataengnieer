Q)  Write  a  program  to  determine  total  and  average  of  student  and  gross pay  and  net  pay  of  teacher 
...
Q)  Write  a  progran  to  add  num  class  objects  and  join  str  class  objects
Ans)  from abc import *
class person(ABC):
    def get(self):
