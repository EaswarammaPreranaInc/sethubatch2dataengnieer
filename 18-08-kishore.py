...
[18-08-2025 12:37] +91 99482 50500: # Identify  error (Home  work)
a = [25 , 10.8 ,  'Hyd' ,  True]
a . sort()                                                                #error
...
for i in a:
    if a.count(i) == 1:   # keep only elements that appear exactly once
        result.append(i)
...
count_first = a.count(a[0])    # how many times first element is repeated
