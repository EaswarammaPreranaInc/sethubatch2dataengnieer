...
print(len(a)) #6
a . add([100 , 200 , 300]) #erroe:list is mutable
...
print(len(s)) #4
print(s) #{10,18,20,15}
s . update(25) #error:int is non sequence
update()  method
--------------------
...
print(len(s)) #7
s . add(a , b , c) #error: add() takes exactly one argument (3 given)
...
print(a) # {'R', 'a', 'm', ' ', 'o'}
print(len(a)) #5
a . update(3 + 4j , 10.8 , True) #error: non-sequnce type
...
print(a) #set()
b = {10 , 20 , 30 , 40}
print(b . pop(2)) #error:  pop()  takes  no  arguments  (1  given)
pop()  method
----------------
...
print(a | b) #error:list and set can't use |
print(b . union(a))  #error:list has no union method
print(a + b) #error: set and list can't use +
