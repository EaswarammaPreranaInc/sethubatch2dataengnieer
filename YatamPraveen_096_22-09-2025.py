...
print(x)
from p1 import f1			#How  to  call  function  f1()  of   _init_  module  in  package  p1  in  another  way
f1()
from p1 import c1			#How  to  call  method  m1()  of  class  c1  in   _init_  module  of  package  p1  in  another  way
a = c1()
a.m1()
