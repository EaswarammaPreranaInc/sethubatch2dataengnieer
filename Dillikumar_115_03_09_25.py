...
def  f1():
	...
	a = 20
def  f2():
    print(a)		#Throws error because, since f2 contains a local instance of a, it doesn't go for global instances. Now it is as good as printing a even before its initialization
    a = 30
    print(a)
def  f3():
	print(a)
...
# End of f2  function
x = 10
f1()                                        #Throws error as we are creating a local instance so x doesn't take global value so it is as good as using x even before its initialization.
f2()                                        #15
print(x)                                    #10