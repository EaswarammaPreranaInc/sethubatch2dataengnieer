...
#2. Write  a  program  to  create  a  directory.Input  is  directory  name  (or)  path  of  the  directory
import os
...
#3. Write  a  program  to  create  a  group  of  directories.Input : a/b/c
import os 
...
#4. Write  a  program  to  delete  a  directory.
import os
try:
    dir = input("Enter  directory  name  (or)  path : ")
    os.rmdir(dir)
...
#5. Write  a  program  to  delete  a  group  of  directories
...
#6. Write  a  program  to  rename  a  file  and  directory
import os
...
#7. Write  a  program  to  print  all  the  files  and  sub-directories  of  input  directory
import os
dir = input("Enter  directory  name (or) path : ")
a = []
b = []
