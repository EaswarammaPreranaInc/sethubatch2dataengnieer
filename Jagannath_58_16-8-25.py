...
a = [1,2,3]
b = [4,5,6]
print(a , id(a))                        [1,2,3] 140711234567888
a += b
print(a , id(a))                        [1,2,3,4,5,6] 140711234567888
...
print(a , id(a))                  [1,2,3] 140711234567888
a  = a + b
print(a , id(a))                  [1,2,3,4,5,6] 140711234568400
...
list = [25 , 10.8 , 'Hyd' , True , 3 + 4j]
a , *b , c , *d , e  = list                           Error because two starred expression *b and *d
