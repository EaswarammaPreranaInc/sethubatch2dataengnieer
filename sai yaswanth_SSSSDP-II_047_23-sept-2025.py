...
print(a . __dict__) # convert  to  dictionary -->{}
...
a . m1(30) # error: arg y is missing
a . m1() # error: arg x , y  are missing
...
class   c1:
    pass
a = c1()
a . m1() # AttributeError: 'c1'  object  has  no  method  'm1'
...
print(a . __dict__) # {}
del   a
print(a . __dict__) #'a' is not defined
...
class triangle:
    def get_sides(self):
        self.x = float(input("Enter the first side: "))
        self.y = float(input("Enter the second side: "))
        self.z = float(input("Enter the third side: "))
