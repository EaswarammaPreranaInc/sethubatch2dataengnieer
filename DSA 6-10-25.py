...
class  queue:
		...
		def  last(q):
				...
				except : # (return   -1  when  queue  is  empty)
					return None
        def  disp(q):
                print(f'Queue : {q.list}') # How  to  print  queue
        def  size(q):
...
while  ch != 7 : # repeat  until  user  input  is  7
	match  ch:
		...
		case  2:
					q . dequeue() # How  to  delete  queue  element  and  print  the  deleted  element
					q . disp() # How  to  print  queue
		case  3:
					q . disp() # How  to  print  the  queue
		case  4:
					f = q . first() # How  to  print  first  element  of  the  queue
					if f == None:
						print('Queue is empty')
					else : 
						print(f'First Element : {f}')
		case  5:
					l = q . last() # How  to  print  last  element  of  the  queue
					if l == None:
						print('Queue is empty')
					else:
						print(f'Last Element : {l}')
		case  6:
					print(f'Number of Elements : {q . size()}') # How  to  print  number  of  elements  in  the  queue
		case 7 : 
					exit()
	# End  of  match
	menu()
