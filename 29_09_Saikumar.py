...
a .__init__(3.8  , 4.6)
print('a  :  ' , a)                 #a  :  3.8/4.6
g = Rat(nr1 = 9 , 5)                #Throws error as positional argument can't follow keyword argument
...
e = Date(dd = 30 , mm = 4 , yy = 2022)      #Throws error as keywords doesn't match
...
print(a . x)                            #Throws error as a doesn't have variable x
...
def c1(x):
    print('Function : ' , x)
# End  of  class  c1
a = c1()                            #Throws error as c1 function expects one arument
b = c1(25)                          #Function : 25
print(b)                            #None
...
t . __m2()                      #Throws error as m2 can't be accessed directly outside class
print('End')
...
# End    of    the    class
a = c1()                #Object is created at address : <say 1000>
...
class   c1:
	...
	def __del__(self):
		print(F'Object  at  address  {id(self)}  is  lost  ')
#end  of  the  class
c = b = a = c1()                #Object is created at address : <say 1000>
del   a
print('Hello')                  #Hello
del   b
print('Hi')                     #Hi
...
class  c1:
    ...
    def __del__(self):
        print(F'Object at address {id(self)} is lost')
#End of the class
list = [c1(), c1(), c1()]           #Object is created at address : <say 1000><next_line>Object is created at address : <say2000><next_line>Object is created at address : <say 3000>
