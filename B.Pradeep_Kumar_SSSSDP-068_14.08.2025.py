...
if a[0] in a[1:]:
    ...
    print("Element Not Found in Remaining Letters")
...
#print(a . split(''))  #  error Due to empty seprator
...
a=input("Enter Addition Numbers with + operator :")
b=a.split('+')
c=0
for i in b:
    c+=int(i)
...
print('' . isdigit())  #  False
print(' ' . isdigit())  #   False
print(9247 . isdigit())  # Error  due to digit in qoutes only this is int 
...
3) i        b[-i]           c
   ...
   --------------------------------------------------------
'''
a=input("Enter input of Sentance :")
b=a.split(' ')
c=""
