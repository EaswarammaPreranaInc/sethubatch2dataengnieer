...
from p1 import mod1 as a,mod2 as b#How  to  import  mod1   and  mod2  of  package  p1  with  from  statement
print(a.x)#How  to  print  object  'x'  of   mod1  in  package  p1
a.f1()#How  to  call  function  f1()  of   mod1  in  package  p1
a=a.c1()
a.m1()#How  to  call  method  m1()  of   class  c1  in  mod1  of  package  p1
print()
print()
print(b.x)#How  to  print  object  'x'  of   mod2  in  package  p1
...
print(x)#error due to there is no x in cwd
