...
class  deque:
	...
	def  size(dq):
			return len(dq.list)  #How  to  return number  of  elements  in  the  deque
#End of the class
def  menu():
	...
	match  ch:
		...
		case  3:
					...
					if x==None:
						...
						print(x)  #How  to  delete  left  most  element  of  deque  and  print  the  deleted  element
		...
		case  4:
					...
					if x==None:
						...
						print(x)  #How  to  delete  right  most  element  of  deque  and  print  the  deleted  element
					dq.disp()   #How  to  print  queue
		case  5:
