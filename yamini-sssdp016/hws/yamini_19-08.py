...
a=eval(input('enter a list: ')) # [10 , 20 , 30]
b=eval(input('enter another list')) #[15 , 18 , 10 ,  12 ,  19 , 20 , 14 , 12 , 30 , 25 ,  16]
i=b.index(a[0])
try:
        for x in a[1:]:
                i=b.index(x,i+1)
...
a = [10 , 20 , 15 , 18]
b = a . copy() # b=[ 10 , 20 , 15 , 18]
print(b) # [10 , 20 , 15 , 18]
print(a  is  b) # false as both doesn't point to same object
print(a  ==  b) # true as elements of a and b are same
c = a[:] # c=[10 , 20 , 15 , 18]
print(c) # [10 , 20 , 15 , 18]
print(a  is  c) # false as both doesn't point to same object
print(a  ==  c) # true as elements of a and b are same
d = a # d points to same object whrer a points
print(d) # [10 , 20 , 15 , 18]
print(a  is  d) # true both points to same object
print(a  ==  d) # true 
...
print(len(a)) # 3 as we have 3 elements in the list
...
print(a[0]) #How  to  print  1st   inner  list)
print(a[2]) # How  to  print  2nd   inner  list)
print(a[3]) #How  to  print  3rd   inner  list)
...
for  x  in  a:
    print(x)  # prints each inner list for each iteration [10 , 20] [30 , 40] [50 , 60]  [70 , 80]
...
a = [[10 , 20 , 30] , [40 , 50 , 60] , [70 , 80 , 90]]
for  x  in  a:
    print(x) # prints each inner list for each iteration [10 , 20 , 30]  [40 , 50 , 60]  [70 , 80 , 90]
print() # prints nothing and goes to next line
for  x , y ,  z  in   a:
	print(x , y , z , sep = '...') # elements of inner list  10...20...30 \n 40...50...60 \n 70...80...90
...
for  x , y  in  a:
	print(x , y ,	sep = '...') # error because we have 4 values in list but only 2 objects
...
print(sorted(a)) # ascending order based on 1st non matching character [[5, 'Amar', 5000.0], [10, 'Rama', 1000.0], [15, 'Rajesh', 3500.0], [18, 'Kiran', 2800.0], [20, 'Sita', 2000.0]]
print(sorted(a , reverse = True)) # descending order based on 1st non matching character[[20, 'Sita', 2000.0], [18, 'Kiran', 2800.0], [15, 'Rajesh', 3500.0], [10, 'Rama', 1000.0], [5, 'Amar', 5000.0]]
print(a) # original list [[10 , 'Rama' , 1000.0] , [20 , 'Sita' , 2000.0] , [15 , 'Rajesh' , 3500.0] , [18 , 'Kiran' , 2800.0] , [5 , 'Amar'  ,5000.0] ]