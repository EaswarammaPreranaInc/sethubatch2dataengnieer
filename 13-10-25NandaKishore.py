...
class    child(parent):
	def    get(self):
        super().get()
		self.c=int(input("Enter a number : ")) #How  to   read  inputs  into   variables  a  and  b  of  object
	...
	def   disp(self):
		...
		print(self.d,self.c,sep='\t') #How  to  print  variables  c  and  d  of  object  in  same  line  separated  by  tab
	def  total(self):
...
class  cylinder(circle):
	...
	def  area(self):
		return   super().area()+(2*math.pi*self.radius*self.h)
	def  volume(self):
...
while  True:
	...
	match  ch:
		...
		case  2:
				cyc=cylinder() #How  to  read  raidus  and  height  into  cylinder  object
				print('Area : ' ,  cyc.area())
				print('Volume :  ' ,  cyc.volume())
		case  3:
				exit()
	# End  of  match
...
class   square:
	def   get(self):
		self.s=eval("Enter side of square: ") #How  to  read  side  of  square
	def   area(self):
		return   self.s**2
	def   peri(self):
		return   4*self.s
class   rectangle(square):
	def   get(self):
		self.a=eval(input("length  of  rectangle : "))#How  to  read  length  of  rectangle
		self.b=eval(input("breadth  of  rectangle : "))
	def   area(self):
...
class   cube(square):
	def   get(self):
		 self.a=eval(input("Enter side of cube : "))
	def   area(self):
		return  6*super().area()
	def   volume(self):
		return  self.a**3
...
class  c5(c1):
	...
	def  m2(self):
		...
		x=c2()#How  to  call  m1()  method  of  class  c2
		x.m1()
		super().m1() #How  to  call  m1()  method  of  class  c1
		self.c5() #How  to  call  m1()  method  of  class  c5
		m1() #How  to  call  m1()  function
# End  of  class  c5
def  m1():
	print('m1 function')
# End  of  the  function
c=c5() #How  to  call  m2()  method  of  class  c5
