...
b = eval(a) # b=eval( '[25 , 10.8 , 'Hyd' , True]' )
...
print(a  is  b) # True
print(a  ==  b) # True
b[2] = 12 # modifying b[2] =12 previously it is 15
print(a) # [10,20,12,18]
...
a = [1,2,3]
b = [4,5,6]
print(a , id(a)) # [1,2,3],Address of a <may be 1000>
a += b # [1,2,3,4,5,6]
print(a , id(a)) # [1,2,3,4,5,6],Address of a <may be 1000>
...
print(a , id(a)) # [1,2,3],Address of a <may be 1000>
a  = a + b  # [1,2,3,4,5,6]
print(a , id(a)) # [1,2,3,4,5,6],Address of a <may be 2000>
...
print('d : ' , d) # 'Hyd'
print('e : ' , e) # True
a , b , *c , d , e , f = list # Error, not enough values to unpack (expected 5, got 4)
...
list = [25 , 10.8 , 'Hyd' , True , 3 + 4j]
a , *b , c , *d , e  = list # Multipul * assignment not possible
...
print('c : ' , c) # c : 'Hyd'
print('d : ' , d) # d : True
a , b , c , d = list # Error, not enough values to unpack (expected 4, got 3)
