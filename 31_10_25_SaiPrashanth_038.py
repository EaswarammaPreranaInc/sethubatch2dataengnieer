...
'''
Output:
main  thread for 10  times with 2 seconds interval
new  thread for 10  times without  any  interval
'''
...
"""
Output:
child  thread for 10  times without  any  interval
main  thread for 10  times without  any  interval
"""
...
print()
print('zip   object  in  the  form  of   dictionary :  ' ,  dict(z5))
