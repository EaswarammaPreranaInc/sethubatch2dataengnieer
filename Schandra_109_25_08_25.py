...
'''
# Program
a=eval(input("Enter your 1st set :"))
b=eval(input("Enter your 2nd set :"))
c=set(a)
d=set(b)
e =c.intersection(d)
f=list(e)
print("Common  elements  between  the  2  lists :",f)
...
print(id(a)) # Address of Dictinary object 'a'
...
print(id(a)) # Address of same Dictonary object'a'
...
a[18]='Kiran'
print(a) # {10:'Rama',20:',20:'Sita',15:'Rajesh',18:'Kiran}
...
for i in range(n):
    ...
    a[name] = salary   # add name and salary to dictionary
print(a)
...
b = dict([("x", 10), ("y", 20)])  
print(b)
d = dict([("x", 10, 30)])   # Error
dict([1, 2, 3])   # Error (not a nested sequence)

# sorted()  function  (Home  work)
a = {10 : 'Red' , 20 : 'Green' , 15 : 'Blue' , 18 : 'Yellow' , 5 : 'White'}
b = sorted(a . keys())
print(b) # [5,10,15,19,20]
c = sorted(a . values())
...
print(a) # {}
del  a
print(a) # Error there is no 'a' dictionary object
...
for ch in sorted(s):          # Iterate in alphabetical order
