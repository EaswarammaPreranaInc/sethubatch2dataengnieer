...
'''
try:
	a = eval(input('Sub list : '))
	b = eval(input('Main list : '))
	j = -1
...
for  x  in  a:
    print(x)
print() # [10 , 20] <next line> [30 , 40] <next line> [50 , 60] <next line> [70 , 80]
for  x , y  in  a:
...
for  x , y  in  a: # error as there no enough elements to iterate through for loop
	print(x , y ,	sep = '...')
