...
print(lambda x: x * x(7))                    # <function <lambda> at ...>
...
# (but 'add' is not defined here → NameError)
add = lambda a, b: a + b
...
print(lambda x, y: x + y('Hyder', 'abad'))       # <function <lambda> at ...>


# Find outputs (Home work)
# large not defined → NameError
print(large(10, 20))         
...
print(lambda x: print(x)(s))          # <function <lambda> at ...>
