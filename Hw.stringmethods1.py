...
e = input("Enter an expression with + only: ")
a = e.split('+')
tsum = 0
for i in a:
    sum += int(i)
...
e = [15 , 36 , 48]
print(':' . join(e))			#error due to elements are not strings
f = ['Sankar' , 'Dayal' , 'Sarma']
print('' . join(f))			#SankarDayalSarma
g = range(5)
print('-' . join(g))			#error due to elements are not strings
...
# Step 3: Concatenate alphabets and digits
result = alpha + digit
