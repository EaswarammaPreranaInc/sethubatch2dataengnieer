...
9.# Parent  and  child  class  constructors (Home  work)
class   parent:
	def   __init__(self):
...
12.# Parent  and  Child  constructor  demo  program  (Home  work)
class  parent:
...
2.#  Write  a  method  to  copy  a  linked  list
...
3.#  Write  destructor  to  delete  whole  linked  list
...
'''
4.Write  a  method  to  reverse  linked  list
