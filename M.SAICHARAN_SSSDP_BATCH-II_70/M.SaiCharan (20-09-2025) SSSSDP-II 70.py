...
a = mod2.c1()#How  to  call  method  m1()  of   class  c1  in  mod2  of  package  p1
a.m1()
#print(p1 . mod1 . x)
#print(x)
...
a = f1()#How  to  call  function  f1()  of   mod1  in  package  p1
...
a = f1()#How  to  call  function  f1()  of   mod2  in  package  p1
...
'''  (Home  work)
3.Save  the  following  code  in    any  file  of  cwd
Find  outputs
'''
x = 30
def   f1():
...
'''  (Home  work)
4.Save  the  following  code  in    any  file  of  cwd
Find  outputs
'''
x = 30
def   f1():
...
''' (Home work)
5.Save  the  following  code  in    any  file  of  cwd
Find  outputs
'''
from  p1 . mod1    import    *
from  p1 . mod2    import    *
...
'''  (Home  work)
6.#Save  the  following  code  in  any  file  of  cwd
...
obj1 = c1_mod1() #How  to  call  method  m1()  of   class  c1  in  mod1  of  package  p1
obj1.m1()
print()
print()
print(x2)#How  to  print  object  'x'  of   mod2  in  package  p1
f1_mod2()#How  to  call  function  f1()  of   mod2  in  package  p1
obj2 = c1_mod2()#How  to  call  method  m1()  of   class  c1  in  mod2  of  package  p1
obj2.m1()
