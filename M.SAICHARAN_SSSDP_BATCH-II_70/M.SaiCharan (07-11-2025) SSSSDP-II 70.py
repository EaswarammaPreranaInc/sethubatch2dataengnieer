...
'''
3.#Repeat  prog5b(File-Create)  with  writelines()  method
...
#Program:
def create(f):
    print('Enter text terminated by ctrl+z (or press Enter + Ctrl+Z + Enter on Windows)')
    lines = []  
    while True:
        try:
            line = input() + '\n'  
...
'''  (Home  work)
4.#Write  a  program  to  print  data  of  the  file
...
'''  (Home  work)
5.#Write  a  program  to  print  file  pagewise  and  page  length = 20   lines
