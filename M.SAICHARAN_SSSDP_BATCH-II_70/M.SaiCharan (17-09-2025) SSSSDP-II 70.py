...
print(x) #Error
print(addtion(10,7)) #How  to  call  add()  function  of  cal  module  by  passing  10  and  7
print(multilpy(10,7)) #How  to  call  mul()  function  of  cal  module  by  passing  10  and  7
a = class_1()
a.m1() #How  to  call  m1()  method  of  class  c1  in  cal  module
...
disp() #function of f1 in mod2
a = c1()#class c1 in mod2
a . m1()#method m1 in mod2
...
class   c1:
	def   m1(self):
		print('m1  method of  class  c1  in  same  module')
print(x) #value of x in current program
disp() #function display in current program
...
from mod1 import x as x1, disp as disp1, c1 as c1_mod1 #How  to  import  members  of  mod1
from mod2 import x as x2, disp as disp2, c1 as c1_mod2 #How  to  import  members  of  mod2
x = 30
def   disp():
        print('disp  function  of  same  module')
class  c1:
...
a = c1_mod2()
a.m2 #How  to  call  method  m1()  of  class   c1  in  mod2
print()
print()
print(x) #How  to  print  variable  'x'  of  current  module
disp() #How  to  call  disp()  function  of current  module
...
import  mod1
import  mod1
#if we import statement any number of times it imports only once



17.# reload()  function  demo  program   (Home  work)
import    importlib
import  mod1
print()
importlib . reload(mod1)#reloads m1
print()
importlib . reload(mod1)#reloads again
importlib . reload('mod1')#Error args not be in strings
