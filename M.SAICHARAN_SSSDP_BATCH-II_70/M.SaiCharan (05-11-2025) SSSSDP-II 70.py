...
continues like same until user terminates the program


'''
2.# How  to  iterate   list_iterator  in  different  ways
import   time
list  =  [10  ,  20  ,  15  ,  18]
...
a = 25
print(a)		# 25
for  x   in   a:	# Error, we cannot iterate the int object
	print(x)
print(iter(a))
print(next(a))
...
4.#Modify  following  program  such  that
...
'''
13.# How  to  print  fliter  object  in  different  ways ?
import   time
...
'''
14.#  Write  a  program  to  print  odd  numbers  between  1  and  20  with  filter  iterator
...
'''
15.#Write  a  program  to  print  distinct  vowels  of  the  string  using  filter.
Input  is  string  and  output  is  set
'''
#Program:
s = input("Enter a string: ")
vowels = 'aeiou'
f = filter(lambda ch: ch in vowels, s.lower())
vowel_set = set(f)
print("Distinct vowels in the string:", vowel_set)


16.# Nested  filter  i.e.  filter  on  filter
import   time
