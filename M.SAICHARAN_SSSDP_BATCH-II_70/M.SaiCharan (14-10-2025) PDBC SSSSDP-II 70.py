...
'''
1.Write  a  program  to  print  emp  table  based  on  user  condition
...
2.Write  a  program  to  print  emp  table  in  sorted  order
...
3.Write  a  program  to  print  user  input  table  with  next()  function
...
4.Write  a  program  to  print  cursor  with  fetchall()  method
