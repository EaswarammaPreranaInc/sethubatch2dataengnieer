...
a = input('Enter  Tuple  :  ')
print(a) #object a in str
print(type(a)) #string
b = eval(a) 
print(b) # object a in tuple
print(type(b)) #tuple
print(len(b)) #no.of elements in tuple
...
print(c) #Hyd
print(d) #True
p , q , r =  x #Error:insufficient values
a , b ,c,d,e=x #Error:insufficient values
