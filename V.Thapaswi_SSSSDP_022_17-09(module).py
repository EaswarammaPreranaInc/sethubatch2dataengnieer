...
# 3) How  to  use  members  of  cal  module  with  from  statement ? 
print('Begin') #Begin
...
# 4) How  to  import  only  variable  'x' ,  functions  add()   and  mul()  and  class  c1  of  cal  module ? 
print('Begin')
...
#17)  reload()  function  demo  program   
import    importlib
import  mod1
print()
