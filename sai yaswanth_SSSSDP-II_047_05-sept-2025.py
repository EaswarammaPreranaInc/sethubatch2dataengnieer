...
print( lambda   x  :  x * x(7)) # class and address of lambda function
print( lambda   x  :   x * x) #class and address of lambda function 
...
print(add()) #error: args are needed
print(add) #class and address of lambda function
...
print(lambda  x , y : x + y  ('Hyder'  ,  'abad')) #class and address of lambda function
...
a  =  lambda  :  'Hyd'
print(a()) #Hyd
print(a) #class and address of function
...
print(a) #(class and address of lambda function,None,None)
for  x  in  a:
    print(x) # class and address of function \n none \n none
a() #Error
print(a[0]()) #Hyd \n none

#  Find  outputs  (Home  work)
s = 'Hyd'
print(lambda  s  :  print(s)) #class and address of function 
print(lambda  x  :  print(x) (s)) #class and address of function
...
print(a) #[class and address of f1 ,class and address of f2 ]
...
key = 'power_3'
print(a[key]) #class and address of function
print(a[key](5)) #125
...
print(lamb(2)) #9
print(lamb(5)) #243
print(lamb) #class and address of function
print(lamb()) #error: 1 arg is needed
...
#print(sorted(a)) #error:dict cann't be sorted directly
...
print(add()) #false
add = lambda  x  :   x = 25 #error = not use in lambda
add = lambda x: x := 25 #error:walrus operator cann't assigned to lambda 
...
print("Whoever picks the last matchstick LOSES the game.\n")

while n > 1:  
    user = int(input("How many matchsticks would you like to pick (1-4)? : "))
    ...
    if n == 1:  
        print("You picked the last matchstick!")
        print("You have lost the game and Computer wins")
        break
    comp = 5 - user
    n -= comp
    print(f"Computer picks {comp} matchstick(s)")
...
roman = input("Enter any roman number : ").upper()
roman = roman[::-1]
total = 0
prev = 0
for char in roman:
