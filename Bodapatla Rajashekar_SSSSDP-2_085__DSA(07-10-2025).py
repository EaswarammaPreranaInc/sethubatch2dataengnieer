...
class  deque:
	...
	def  del_front(dq):
			try : # How  to  remove  left  most  element  of  the  deque  and  return  the  deleted  element
				return dq . list . pop(0)
			except : # (return  None  when  deletion  is  not  possible)
				return None
	def  del_rear(dq):
			try : # How  to  remove  right  most  element  of  the  deque  and  return  the  deleted  element
				return dq . list . pop()
			except : # (return  None  when  deletion  is  not  possible)
				return None
	def left_most(dq):
	...
	def right_side(dq):
		try:
			...
			return None
	def  disp(dq):
		print(dq.list) # How  to  print  deque
	def  size(dq):
...
while  True:
	...
	match  ch:
		...
		case  2:
					...
					dq . disp() # How  to  print  deque
		case  3:
					x = dq . del_front() # How  to  delete  left  most  element  of  deque  and  print  the  deleted  element
					if x == None:
						print('Value deletion is not possible')
					else: 
						print(f'Left Most Deleted Value : {x}')
					dq . disp() # How  to  print  queue
		case  4:
					x = dq . del_rear() # How  to  delete  right  most  element  of  deque  and  print  the  deleted  element
					if x == None:
						print('Value deletion is not possible')
					else: 
						print(f'Right Most Deleted Value : {x}')
					dq . disp() # How  to  print  queue
		case  5:
					dq . disp() # How  to  print  the  queue
		case  6:
					x = dq.left_most() # How  to  print  left  most  element  of  deque
					if x == None:
						print('No Elements in the Queue')
					else:
						print(f'Left Most Element is : {x}')
		case  7:
					x = dq . right_most() # How  to  print  right  most  element  of  deque
					if x == None:
						print('No Elements in the Queue')
					else:
						print(f'Right Most Element is : {x}')
		case  8:
					print(dq . size()) # How  to  print  number  of  elements  in  deque
		case  9:
