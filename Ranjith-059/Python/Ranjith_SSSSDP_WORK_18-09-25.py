...
import  cal
print(dir(cal))
 #['__buitins__','__cached__','__doc__','__file__','__loader__','__name__','__package__','__spec__','add','sub','mul','div','c1','x','y']
...
# print(type(dir()))
# print(type(dir))
print(dir()) # ['__annotations__','__buitins__','__cached__','__doc__','__file__','__loader__','__name__','__package__','__spec__','c1','disp','x']
...
print(dir()) #['__annotations__','__buitins__','__cached__','__doc__','__file__','__loader__','__name__','__package__','__spec__']
print()
import  cal
print()
print(dir()) #['__annotations__','__buitins__','__cached__','__doc__','__file__','__loader__','__name__','__package__','__spec__','cal',']
# here we imported the cal so directory has we get the cal

print(dir()) #['__annotations__','__cached__','__builtins__','__doc__','__file__','__loader__','__name__','__package__','__spec__']
print()
from  cal  import  *
print()
print(dir()) #['__annotations__','__builtins__','__cached__','__doc__','__file__','__loader__','__name__','__package__','__spec__','add','sub','mul','div','c1','x','y']
