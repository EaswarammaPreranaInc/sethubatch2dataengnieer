...
lst = eval(input("Enter a list: "))   #input: [False, 25, 10.8, 1, 25, 0, 'Hyd', 10.8, 1.0, None, 'Sec', 'Hyd', True]

unique = list(set(lst))
print(unique)                       # [False, 1, None, 'Sec', 10.8, 25, 'Hyd']
...
a = eval(input("Enter first list: "))   #[10, 20, 30, 40, 50, 60]
b = eval(input("Enter second list: "))  #[30, 40, 70, 80, 20]

common = list(set(a) & set(b))
print(common)   # [40, 20, 30] (order may vary)
...
n = int(input("How many Employees ? : "))   # 4
a = {}
for i in range(n):
    name = input("Enter Emp Name : ")
    sal = float(input("Enter Salary : "))
    a[name] = sal
print(a)          # {'AAA': 100000.0, 'BBB': 200000.0, 'CCC': 150000.0, 'DDD': 175000.0}
...
# print(dict([[10, 20, 30], [40, 50, 60]]))                        #Error
...
print(a)                                  # {5: 'D', 10: 'A', 12: 'E', 15: 'C', 20: 'B'}
...
s = input("Enter mixed case string : ")            # RamA raO
s = s.upper()
a = {}
for ch in sorted(s):
    if ch.isalpha():
