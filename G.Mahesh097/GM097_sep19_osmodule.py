...
os . system('py  sample.py')  #  py  sample.py executes and shows the result   
...
'''
Enter  directory  name  (or) path :  mahesh
Directory  sssdc2  created
Enter  directory  name  (or) path :  mahesh
Directory  sssdc2  already  exists
Enter  directory  name  (or) path :  mahesh/khairtabad
Directory  mahesh/khairtabad  created
'''
...
Enter  directory  name  (or)  path :  mahesh
Directory  mahesh  is  removed
Enter  directory  name  (or)  path :  mahesh
Directory  mahesh  does  not  exist
...
'''
output:
Enter the current filename or directory name: test
Enter the new filename or directory name: test1
Renamed test to test1 
Enter the current filename or directory name: sample
Enter the new filename or directory name: test
test already exists
'''
