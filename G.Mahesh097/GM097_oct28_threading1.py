...
t1 . start() 	#  What  does  thread  t1  do ? -- executes f1 function and output is f1 function (10 times)
t2 . start()  	#  What  does  thread  t2  do ? -- executes method m1 of a new c1 object and output is m1 method of class c1 (10 times)
t3 . start()    #  What  does  thread  t3  do ? -- No target, hence executes empty run() of Thread class and output is nothng 
t4 . start()    #  What  does  thread  t4  do ? -- executes overridden run() and output is run method of MyThread class (run 10 times)
t5 . start()    #  What  does  thread  t5  do ? -- executes run() and output is f1 func (10 times)
t6 . start()  	#  What  does  thread  t6  do ? -- executes subclass of c1 of Thread and output is f1 func (10 times)
t7 . start() 	#  What  does  thread  t7  do ? -- No target, hence executes empty run() of Thread class and output is nothng 
t8 . start()    #  What  does  thread  t8  do ? -- executes c1().m1() and o/p is m1 method of class c1 (10 times)
t9 . start()    #  What  does  thread  t9  do ? -- executes c1().m1() and o/p is m1 method of class c1 (10 times)
t10 . start()   #  What  does  thread  t10 do ? -- run method of MyThread class (10 times)
t11 . start()   #  What  does  thread  t11 do ? -- base Thread.run() and o/p is nothing
t12 . start()   #  What  does  thread  t12 do ? -- m1 method of MyThread class (10 times)
...
child = current_thread(name='Sec')  #How  to  create  a  new  child  thread  with  name  "Sec"
...
# Find  outputs (Home  work)
from threading import *
t1=Thread(name='t1') #How  to  create  three  new  threads  t1 , t2 , t3
t2=Thread(name='t2')
t3=Thread(name='t3')
