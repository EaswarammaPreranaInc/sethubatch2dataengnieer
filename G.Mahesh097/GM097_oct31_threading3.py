...
import time
def  disp():
	main_thread() . join()  # new thread waits for main_thread expiry
	for  i  in  range(10):
		print('child  thread')
child = Thread(target = disp)
child . start()
child . join()      # main thread waits for new thread expiry
for  i  in  range(10):
	  print('main  thread')

''' No output because child waits for main thread to die and main thread waits for new thread to die
'''
...
z6=zip(a,b)
print('Unpacks  zip  object  with   *  operator  :  ' , *z6)
print()

z7=zip(a,b)
print('zip   object  in  the  form  of   list  :  ' , list(z7))
print()

z8=zip(a,b)
print('zip   object  in  the  form  of   dictionary :  ' , dict(z8))
