...
try:
    ...
    print('else')   # else cant be used without the except suite
finally:
    print('finally')
print('End')
...
try:
	print('try')
# else:
# 	print('else')	# else  suite should be after the except  suite
except:
	print('except')
finally:
	print('finally')
...
try:
	...
	print('ValueError  of  outer  try')	# executed
except   IndexError:
...
''' 
possible output
Rama guess 23 in attempt : 1
Sita guess 17 in attempt : 1
