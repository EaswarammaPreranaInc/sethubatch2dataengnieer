...
a = {10 , 20 , 30 , 40} # ref 'a' is assigned to set obj
b = {30 , 40 , 50 , 60} # ref 'b' is assigned to set obj
...
a = {10 , 20 , 30 , 40} # ref 'a' is assigned to set obj
b = {30 , 40 , 50 , 60} # ref 'b' is assigned to set obj
c = a . symmetric_difference(b) # union - intersect
print(c) # {10, 20, 50, 60}
print(type(c)) # <class 'set'>
d = a ^ b # union - intersect
print(d) # {10, 20, 50, 60}
print(type(d)) # <class 'set'>
print(c   is   d) # False
print(c  ==   d) # True
...
c = set(a)
d = c.intersection(set(b))
print("Common elements  in  both  lists  :", list(d))
...
a  =  {'Empno'  :  25 ,  'Ename'  :  'Rama  Rao'  ,  'Sal'  :  1000.65  } # dict obj
...
a['Empno'] = 25 # How  to  modify  25   to  35
...
a =  {10 : 20 , 30 : 40 , 50 : 60 , 70 : 80} # dict obj
...
a = input('Enter  dictionary  :  ') # reads input string
print(a) # {10: 'A', 20: 'B', 15: 'C' , 20 : 'D'}
print(type(a)) # <class 'str'>
b = eval(a) # converts str into dict
print(b) # {10: 'A', 20: 'B', 15: 'C' , 20 : 'D'}
print(type(b)) # <class 'dict'>


#  Find  outputs  (Home  work)
a = {10 : 'Rama' , 20 : 'Sita' , 15 : 'Rajesh' , 18 : 'Kiran'} # dict obj
b = {**a} # it gives dict of key-value pairs
print(b) # {10 : 'Rama' , 20 : 'Sita' , 15 : 'Rajesh' , 18 : 'Kiran'}
print(a  is  b) # False
print(a  ==  b) # True
c = a # ref 'c' is pointing to ref 'a'
print(a  is   c) # True
print(a  ==  c) # Ture


#Find  outputs  (Home  work)
a = {10 : 'Rama' , 20 : 'Sita' , 15 : 'Rajesh'} # dict obj
b = {18 : 'Kiran' , 14 : 'Amar' , 20  : 'Manohar'} # dict obj
c = {25 : 'Ramesh' , 19 : 'Krishna' , 15 : 'Radha' , 14 : 'Srinivas'} # dict obj
d = {*a , *b , *c} # {10, 14, 15, 18, 19, 20, 25}
...
#  Find  outputs  (Home  work)
a = {10 : 20 , 30 : 40} # dict obj
b = {30 : 50 , 10 : 60} # dict obj
print(a + b) # error
c = {**a , **b} # {10:60, 30:50}
print(c) # {10:60, 30:50}
d = a | b # {10: 60, 30: 50}
...
a = [ (10 , 'Hyd') , (20 , 'Sec') , (15 , 'Cyb') , (20 , 'Pune')] # list obj
...
g = [[10 , [20 , 30]] , [40 , [50 , 60]] , [70 , [80 , 90]]] # list obj
...
a = {10 : 'Red' , 20 : 'Green' , 15 : 'Blue' , 18 : 'Yellow' , 5 : 'White'} # dict obj
...
a = {10 : 'Hyd' , 20 : 'Sec' , 15 : 'Cyb' , 18 : 'Pune'}
b = a . values() # dict_values(['Hyd','Sec'.'Cyd','Pune'])
print(b) # dict_values(['Hyd','Sec','Cyd','Pune'])
print(type(b)) # <class 'dict_values'>
for  x   in   b:
	print(x) # 'Hyd','Sec','Cyd','Pune'
