...
a = [25 , 10.8 ,  'Hyd' ,  True]
a . sort()#Error,collections of strings and numbrs cannot be sorted
...
result = []
for item in lst:
    if lst.count(item) == 1:   # keep only if occurs once
        result.append(item)

print("List after removing all duplicates:", result)
