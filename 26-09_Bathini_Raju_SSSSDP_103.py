...
print(s . __dict__)  # {}
s . get()
print(s . __dict__)  # {'id': 25, 'name': 'Rama Rao', 'g': 'male', 'marks': [52, 48, 55]}
s . compute()
print(s . __dict__)  # {'id': 25, 'name': 'Rama Rao', 'g': 'male', 'marks': [52, 48, 55], 'total': 155, 'avg': 51.6, 'grade': 'Third class'
