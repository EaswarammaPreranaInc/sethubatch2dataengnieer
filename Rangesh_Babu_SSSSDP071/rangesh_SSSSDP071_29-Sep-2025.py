...
a . __init__(3.8  , 4.6)
print('a  :  ' , a)
g = Rat(nr1 = 9 , 5)#error due to after KA no PA is permitted
h = Rat(nr = 9 , dr = 5)#error due to argument is nr1 not nr
...
d = Date()#error due to argument is mandatory
e = Date(dd = 30 , mm = 4 , yy = 2022)
f = Date(dd1 = 26 , mm1 = 8 , 2023)#error as after KA, PA is not permitted
...
# End  of  class
a = c1()#error due to constructor should return None 
b = c2()
print(b)#c1 class constructor
print(b . __init__())#None
c = c3()#error due to constructor should return None 
print(c . __init__())
...
def    c1(x):
        print('Function : ' , x)
# End  of  class  c1
#a = c1()#error due to one argument missing
b = c1(25)
...
Enter name of student: Prasanna
Enter m or f: m
...
Grade :  Distinction
Roll: 101, Name: Prasanna, Gender: m, Total: 221, Average: 73.67, Grade: Distinction'''
...
class  Test:
	...
	def  m1(self):
		print('m1  method')
		print("x =", self.x)#How  to  print   variable  'x'
		print("y =", self.__y)#How  to  print  private  variable  'y'
...
t = Test()
print('Outside')
print("x =", t.x)#How  to  print  variable  'x'
print("y =", t._Test__y)#How  to  print   variable  'y'
print(t . __y)#error due to attributeerror
print(t . __dict__)
t.m1()#How  to  call  method  m1()
t._Test__m2()#How  to  call   method  m2()
t . __m2()#error attributeerror
print('End')
