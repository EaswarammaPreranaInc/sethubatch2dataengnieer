...
def  f1():
        ...
        yield  30
        yield  40
a , b , c = f1() # more values to unpack 
p , q , r , s , m = f1() # less values to unpack
...
# End  of  generator
g =  f1()
print(len(g)) # error:generator has no indexes
print(g * 3) # error:generator doesn't support *
print(g[0]) # error:generator has no indexes
print(g[1 : 3]) # error:generator has no indexes
print(*g) #1 2 3
