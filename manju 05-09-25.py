...
print( lambda   x  :  x * x(7))#<function <lambda> and some address>
print( lambda   x  :   x * x)#<function <lambda> and some address>
...
print(lambda  x , y : x + y  ('Hyder'  ,  'abad'))#<function <lambda> and some address


#9th program
#  Find  outputs (Home  work)
#How  to  define  lambda  to  detrmine  largest  of  two  arguments
large=lambda a=1,b=2:max(a,b)
...
print(add('Hyder' , 'abad'))#Hyderabd
print(add(True , False))#1
print(add(25 , 10.8))#35.8
print(add(3 + 4j , 5 + 6j))#(8+10j)
#print(add(10 , '20'))#error
print(add())#3
print(add)#<function <lambda> and some address>
...
#  Find  outputs  (Home  work)
s = 'Hyd'
print(lambda  s  :  print(s))#<functioon <lambda> and address>
...
key = 'power_3'
print(a[key])#<function <lambda> and address>
print(a[key](5))#125
...
print(lamb(5))#243
print(lamb)
#print(lamb())#error missing one required positional 
...
#print(sorted(a))#error dict object can not be compare with < or > operator
