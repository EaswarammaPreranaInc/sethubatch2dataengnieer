...
print('After')
run_module('mod2') # Error No run_module() function in current module
runpy . run_module(mod2) # Error argument should be string
...
#2) What  are  the  members  of  cal  module ?  --->  Two  objects  x  and  y ,Four  functions  add() , sub() , mul()  and  div()  and class  c1

#3) Is  m1()  a  member  of  cal  module ?  ---> No  becoz  it  is  a  method  of  class

#4) How  many  statements  are  in  cal  module ?  --->  Two i.e.  x =  100   and  y = 200
...
print(x) # How  to  print  variable  'x'  of  cal   module
print(y) # Error member of y is not in current module
print(cal . x) # Error module is not imported
print(add(10,7)) #How  to  call  add()  function  of  cal  module  by  passing  10  and  7
...
print(cal . x) # module cal is not imported
from  math  as   m  import  * # module alias is not permitted in from statement

# Member  alias
from cal import x as k,add as sum, mul as product, c1 as c2 #How  to  import  members   x , add , mul  and  class  c1  of  cal  moudle   with  another  name   using   from  statement
print(k)   #How  to  print  variable  'x'  of  cal   module
print(x) # error object x is not in current module
print(sum(10, 7)) #How  to  call  add()  function  of  cal  module  by  passing  10  and  7
print(product(10, 7)) #How  to  call  mul()  function  of  cal  module  by  passing  10  and  7
a=c2()
a.m1() #How  to  call  m1()  method  of  class  c1  in  cal  module
...
5) from  cal   import   *
    Which  members  are  imported  when  _all_  list  is  not  defined  in  cal  module ?  --->All  the  members  are  imported  becoz  default  _all_  is   every  member  of  the  module
6) from  cal   import   *
...
print(div(10 , 7)) # Error
a = c1()
a . m1() # method of imported class c1 from cal module
