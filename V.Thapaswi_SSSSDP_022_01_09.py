...
f1(13)#[13]
print('__defaults__  :  ' , f1.__defaults__)#([13],)
f1(4 , [1 , 2 , 3])#[1, 2, 3, 4]
print('__defaults__  :  ' , f1.__defaults__)#([13],)
f1(9)#[13, 9]
print('__defaults__ :  ' , f1.__defaults__)#([13, 9],)
f1(40 , [10 , 20 , 30])# [10, 20, 30, 40]
print('__defaults__  :  ' , f1.__defaults__)#([13, 9],)
f1(5)#[13, 9, 5]
print('__defaults__ :  ' , f1.__defaults__)#([13, 9, 5],)
f1([6 , 7 , 8])#[13, 9, 5, [6, 7, 8]]
print('__defaults__  :  ' , f1.__defaults__)#([13, 9, 5, [6, 7, 8]],)
