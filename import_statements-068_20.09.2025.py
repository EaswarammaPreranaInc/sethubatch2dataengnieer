...
print(p1 . mod1 . x)  #  Error due to were not imported p1
print(x)  #  Error due to x is not defined in current module



#  Save  in  any  file  of  cwd
import p1.mod1,p1.mod2   #How  to  import  members  of  mod1  in  package  p1
...
b=f1()  #  How  to  call  function  f1()  of   mod2  in  package  p1
b.m1()  #  How  to  call  method  m1()  of   class  c1  in  mod2  of  package  p1
print(p1 . mod1 . x)   #  x value in mod1
print(mod1 . x)  #  Error
...
f1()  #mod2 f1() in p1
a = c1()
a . m1()  #   m1 of class c1 in mod2 in p1
...
from p1.p2 import mod2   #   How  to  import   members  of  mod2   in  package  p1  with  from  statement
...
print()
print(mod2.x)   #   How  to  print  object  'x'  of   mod2  in  package  p1
f=mod2.f1()   #   How  to  call  function  f1()  of   mod2  in  package  p1
f.m1()  #  How  to  call  method  m1()  of   class  c1  in  mod2  of  package  p1



# Save  in  any  file  of  cwd
import p1.mod1   #   How  to  import  members  of  mod1  in   package  p1
import p1.p2.mod2   #  How  to  print  object  'x'  of   mod1  in  package  p1
p1.mod1.f1()  #  How  to  call  function  f1()  of   mod1  in  package  p1
f=p1.mod1.c1()   
f.m1()  #  How  to  call  method  m1()  of   class  c1  in  mod1  of  package  p1
print()
print()
...
p=c1()   #   How  to  call  function  f1()  of   mod2  in  sub-package  p2  of  package  p1
p.m1()   #  How  to  call  method  m1()  of  class   c1   in  mod2  of  sub-package  p2  in  package  p1
